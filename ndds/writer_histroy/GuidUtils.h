...
#ifndef NDDS_DCPS_GUIDUTILS_H
#define NDDS_DCPS_GUIDUTILS_H
...
/// Vendor Id value specified for OCI is used for NDDS.
...
enum EntityKind {     // EntityId_t.entityKind value(s)
  ...
  /// Represents ENTITYKIND_NDDS_TOPIC
  KIND_USER_TOPIC,
...
struct NDDS_Dcps_Export GUID_tKeyLessThan {
...
struct NDDS_Dcps_Export EntityId_tKeyLessThan {
...
struct NDDS_Dcps_Export BuiltinTopicKey_tKeyLessThan {
...
typedef NDDS_SET_CMP(GUID_t, GUID_tKeyLessThan) GuidSet;
...
NDDS_OOAT_STD_HASH(NDDS::DCPS::GUID_t, NDDS_Dcps_Export);
#endif

#endif /* NDDS_DDS_DCPS_GUIDUTILS_H */
