...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDSTRATEGY_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDSTRATEGY_H
 ...
 *    of samples in queue.
 */
class NDDS_Dcps_Export TransportSendStrategy
...
private:
  ...
  NDDS_VECTOR(TQESendModePair) delayed_delivered_notification_queue_;
...
#endif /* NDDS_DCPS_TRANSPORTSENDSTRATEGY_H */
