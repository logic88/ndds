...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDELEMENT_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDELEMENT_H
...
class NDDS_Dcps_Export TransportSendElement : public TransportQueueElement {
public:
...
#endif  /* NDDS_DCPS_TRANSPORTSENDELEMENT_H */
