...
NDDS::DCPS::TransportSendElement::~TransportSendElement()
{
  DBG_ENTRY_LVL("TransportSendElement", "~TransportSendElement", 6);
}

void
NDDS::DCPS::TransportSendElement::release_element(bool dropped_by_transport)
{
...
NDDS::DCPS::RepoId
NDDS::DCPS::TransportSendElement::publication_id() const
{
...
NDDS::DCPS::RepoId
NDDS::DCPS::TransportSendElement::subscription_id() const
{
...
ACE_Message_Block*
NDDS::DCPS::TransportSendElement::duplicate_msg() const
{
...
NDDS::DCPS::TransportSendElement::msg() const
{
...
const ACE_Message_Block*
NDDS::DCPS::TransportSendElement::msg_payload() const
{
