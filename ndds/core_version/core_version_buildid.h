...
#ifndef NDDS_DCPS_SECURITY_FRAMEWORK_SECURITYPLUGININST_H
#define NDDS_DCPS_SECURITY_FRAMEWORK_SECURITYPLUGININST_H
 ...
 *
 */
class NDDS_Dcps_Export SecurityPluginInst : public DCPS::RcObject {
public:
