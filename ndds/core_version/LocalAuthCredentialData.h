...
#ifndef NDDS_DCPS_SECURITY_AUTHENTICATION_LOCALAUTHCREDENTIALDATA_H
#define NDDS_DCPS_SECURITY_AUTHENTICATION_LOCALAUTHCREDENTIALDATA_H
...
class NDDS_Security_Export CredentialHash
{
public:
...
class NDDS_Security_Export LocalAuthCredentialData : public DCPS::RcObject {
public:
