...
#ifndef NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPINST_H
#define NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPINST_H
...
class NDDS_Rtps_Udp_Export RtpsUdpInst : public TransportInst {
public:
  ...
  const TransportBLOB* get_blob(const NDDS::DCPS::TransportLocatorSeq& trans_info) const;
...
private:
  ...
  explicit RtpsUdpInst(const NDDS_STRING& name);
