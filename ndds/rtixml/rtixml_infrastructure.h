...
#ifndef NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSSAMPLEHEADER_H
#define NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSSAMPLEHEADER_H
...
class NDDS_Rtps_Udp_Export RtpsSampleHeader {
public:
...
public:
  ...
  // translating from an NDDS data structure to the RTPS format.
...
private:
  static void process_iqos(DataSampleHeader& opendds,
                           const NDDS::RTPS::ParameterList& iqos);
};
