...
#ifndef NDDS_DCPS_QOS_XML_HANDLER_XML_STRING_INTF_H
#define NDDS_DCPS_QOS_XML_HANDLER_XML_STRING_INTF_H
#include /**/ "ace/pre.h"
...
#include "NDDS_XML_QOS_Handler_Export.h"
...
namespace DCPS {
  ...
  class NDDS_XML_QOS_Handler_Export QOS_XML_String_Handler :
