...
namespace {
  const NDDS::RTPS::StatusInfo_t STATUS_INFO_REGISTER = { { 0, 0, 0, 0 } },
...
{
  using namespace NDDS::RTPS;
#if defined(NDDS_TEST_INLINE_QOS)
  NDDS_STRING output("into_received_data_sample(): ");
