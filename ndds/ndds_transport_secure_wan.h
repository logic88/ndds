...
#ifndef NDDS_DCPS_VALUE_WRITER_H
#define NDDS_DCPS_VALUE_WRITER_H
...
class NDDS_Dcps_Export ValueWriter {
public:
  ValueWriter()  {}
  virtual ~ValueWriter() {}
  ...
  virtual void write_fixed(const NDDS::FaceTypes::Fixed& /*value*/) = 0;
...
#endif  /* NDDS_DCPS_VALUE_WRITER_H */
