...
#ifndef NDDS_DCPS_SECURITY_ACCESSCONTROLBUILTINIMPL_H
#define NDDS_DCPS_SECURITY_ACCESSCONTROLBUILTINIMPL_H
...
*
*/
class NDDS_Security_Export AccessControlBuiltInImpl
...
private:
  ...
  private:
    typedef NDDS_MAP(DDS::Security::PermissionsHandle, time_t) HandleToExpiration;
    typedef NDDS_MULTIMAP(time_t, DDS::Security::PermissionsHandle) ExpirationToHandle;
...
#endif // NDDS_DCPS_SECURITY_ACCESSCONTROLBUILTINIMPL_H
