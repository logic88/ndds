#ifndef NDDS_DCPS_XTYPES_DYNAMIC_TYPE_H
#define NDDS_DCPS_XTYPES_DYNAMIC_TYPE_H
...
class NDDS_Dcps_Export DynamicType : public DCPS::RcObject
{
public:
  DynamicType();
  ~DynamicType();
...
NDDS_Dcps_Export bool operator==(const DynamicType& lhs, const DynamicType& rhs);
...
#endif  /* NDDS_DCPS_XTYPES_DYNAMIC_TYPE_H */
