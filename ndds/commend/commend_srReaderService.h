...
#ifndef NDDS_DCPS_XTYPES_TYPE_LOOKUP_SERVICE_H
#define NDDS_DCPS_XTYPES_TYPE_LOOKUP_SERVICE_H
...
class NDDS_Dcps_Export TypeLookupService : public virtual DCPS::RcObject {
public:
  TypeLookupService();
  ~TypeLookupService();
  ...
  typedef NDDS_MAP(TypeIdentifier, DynamicType_rch) DynamicTypeMap;
  typedef NDDS_MAP(DCPS::GUID_t, DynamicTypeMap) GuidTypeMap;
...
private:
  ...
  typedef NDDS_MAP(TypeIdentifier, TypeIdentifierWithSizeSeq) TypeIdentifierWithSizeSeqMap;
  ...
  typedef NDDS_MAP(TypeIdentifier, TypeIdentifier) TypeIdentifierMap;
  ...
  typedef NDDS_MAP_CMP(DDS::BuiltinTopicKey_t, TypeInformation,
...
#endif /* ifndef NDDS_DCPS_XTYPES_TYPE_LOOKUP_SERVICE_H */
