                                         ...
                                         const MinimalTypeObject& tb) const
{
  ...
  NDDS_SET(ACE_CDR::Long) labels_set_a;
  ...
  if (!type_consistency_.ignore_member_names) {
    NDDS_MAP(MemberId, ACE_CDR::ULong) id_to_name_a;
    NDDS_MAP(ACE_CDR::ULong, MemberId) name_to_id_a;
    for (unsigned i = 0; i < ta.union_type.member_seq.length(); ++i) {
                                        ...
                                        const MinimalTypeObject& tb) const
{
  ...
  NDDS_MAP(ACE_CDR::ULong, ACE_CDR::Long) ta_name_to_value;
  ...
  if (IS_FINAL == ta_ext) {
    ...
    NDDS_MAP(ACE_CDR::ULong, ACE_CDR::ULong) ta_value_to_name;
    for (size_t i = 0; i < size_a; ++i) {
