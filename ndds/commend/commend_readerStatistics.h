...
#ifndef NDDS_DCPS_XTYPES_TYPE_ASSIGNABILITY_H
#define NDDS_DCPS_XTYPES_TYPE_ASSIGNABILITY_H
...
typedef NDDS_VECTOR(MemberPair) MatchedSet;
...
class NDDS_Dcps_Export TypeAssignability {
public:
...
#endif /* NDDS_DCPS_XTYPES_TYPE_ASSIGNABILITY_H */
