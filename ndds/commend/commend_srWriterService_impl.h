...
#ifndef NDDS_DCPS_SECURITY_AUTHENTICATIONBUILTINIMPL_H
#define NDDS_DCPS_SECURITY_AUTHENTICATIONBUILTINIMPL_H
...
*
*/
class NDDS_Security_Export AuthenticationBuiltInImpl
