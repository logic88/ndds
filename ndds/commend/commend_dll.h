...
#ifndef NDDS_DCPS_XTYPES_DYNAMIC_DATA_H
#define NDDS_DCPS_XTYPES_DYNAMIC_DATA_H
...
// is enabled, these sequences are defined in NDDS.  Otherwise they come from
...
class NDDS_Dcps_Export DynamicData {
public:
  DynamicData();
...
private:
  ...
  typedef NDDS_SET(DCPS::String) DynamicTypeNameSet;
  bool check_xcdr1_mutable_i(const DynamicType_rch& dt, DynamicTypeNameSet& dtns);

  typedef NDDS_VECTOR(ACE_Message_Block*) IntermediateChains;
...
NDDS_Dcps_Export bool print_dynamic_data(
