                                                          ...
                                                          , bool associate)
{
  ...
  case 0:
    ...
    if (NDDS::DCPS::DCPS_debug_level > 0) {
      NDDS::DCPS::RepoIdConverter converter(subscription->get_id());
      ACE_DEBUG((LM_DEBUG,
...
int DCPS_IR_Topic_Description::add_topic(DCPS_IR_Topic* topic)
{
  ...
  case 0:
    ...
    if (NDDS::DCPS::DCPS_debug_level > 0) {
      NDDS::DCPS::RepoIdConverter converter(topic->get_id());
      ACE_DEBUG((LM_DEBUG,
...
void DCPS_IR_Topic_Description::try_associate_subscription(DCPS_IR_Subscription* subscription)
{
  ...
  // Check the subscriptions QOS status
  NDDS::DCPS::IncompatibleQosStatus* qosStatus =
                                          ...
                                          int depth) const
{
  ...
  for (DCPS_IR_Topic_Set::const_iterator top = topics_.begin();
       ...
       top++)
  {
    NDDS::DCPS::RepoIdConverter top_converter((*top)->get_id());
