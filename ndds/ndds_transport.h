...
#ifndef NDDS_DCPS_VALUE_READER_H
#define NDDS_DCPS_VALUE_READER_H
...
class NDDS_Dcps_Export ValueReader {
public:
  ValueReader() {}
  virtual ~ValueReader() {}
  ...
  virtual bool read_fixed(NDDS::FaceTypes::Fixed& value) = 0;
...
#endif  /* NDDS_DCPS_VALUE_READER_H */
