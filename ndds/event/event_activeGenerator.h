...
class NDDS_Federator_Export ManagerImpl
  : public virtual POA_NDDS::Federator::Manager,
...
public:
  ...
  virtual NDDS::DCPS::DCPSInfo_ptr repository();
  ...
  void localRepo(::NDDS::DCPS::DCPSInfo_ptr repo);
...
private:
  ...
  NDDS::DCPS::SequenceNumber sequence_;
  ...
  NDDS::DCPS::DCPSInfo_var localRepo_;
