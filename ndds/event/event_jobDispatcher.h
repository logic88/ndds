...
class NDDS_InfoRepoLib_Export PersistenceUpdater : public Updater, public ACE_Task_Base {
public:
  class IdType_ExtId {
  public:
    IdType_ExtId();
...
private:
  ...
  NDDS::DCPS::unique_ptr<ALLOCATOR> allocator_;
...
class NDDS_InfoRepoLib_Export PersistenceUpdaterSvc_Loader {
public:
  static int init();
};
