...
ShmemTransport::configure_i(ShmemInst& config)
{
  ...
  ACE_ERROR_RETURN((LM_ERROR, ACE_TEXT("(%P|%t) ERROR: ")
                   ...
                   false);
#else // ifdef NDDS_SHMEM_UNSUPPORTED

  ShmemAllocator::MEMORY_POOL_OPTIONS alloc_opts;
#  if defined NDDS_SHMEM_WINDOWS
  alloc_opts.max_size_ = config.pool_size_;
#  elif defined NDDS_SHMEM_UNIX
...
#  endif // if defined NDDS_SHMEM_WINDOWS
...
#  elif defined NDDS_SHMEM_UNIX
  ...
  ace_sema.sema_ = pSem;
#    ifdef NDDS_SHMEM_UNIX_EMULATE_SEM_TIMEOUT
...
#  endif // if defined NDDS_SHMEM_WINDOWS
  ...
  return true;
#endif // ifdef NDDS_SHMEM_UNSUPPORTED
}
...
#  elif defined NDDS_SHMEM_UNIX
    ::sem_destroy(pSem);
#  endif // if defined NDDS_SHMEM_WINDOWS
#endif // ifndef NDDS_SHMEM_UNSUPPORTED
