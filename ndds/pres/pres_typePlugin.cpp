...
::DDS::Security::ValidationResult_t AuthenticationBuiltInImpl::validate_local_identity(
  ...
  ::NDDS::DCPS::GUID_t & adjusted_participant_guid,
  ::DDS::Security::DomainId_t /*domain_id*/,
  const ::DDS::DomainParticipantQos & participant_qos,
  const ::NDDS::DCPS::GUID_t & candidate_participant_guid,
  ::DDS::Security::SecurityException & ex)
{
  ...
  ::DDS::Security::SecurityException & ex)
{
  ...
  if (local_data) {
    ...
    NDDS::Security::TokenWriter identity_wrapper(identity_token, Identity_Status_Token_Class_Id);
...
::DDS::Security::ValidationResult_t AuthenticationBuiltInImpl::validate_remote_identity(
  ...
  const ::NDDS::DCPS::GUID_t & remote_participant_guid,
  ::DDS::Security::SecurityException & ex)
{
  ACE_Guard<ACE_Thread_Mutex> identity_data_guard(identity_mutex_);
  ...
  ::DDS::Security::SecurityException & ex)
{
  ...
  NDDS::Security::TokenWriter message_out(handshake_message, build_class_id(Handshake_Request_Class_Ext));
  ...
  NDDS::Security::TokenReader auth_wrapper(remote_data.local_auth_request);
...
void extract_participant_guid_from_cpdata(const DDS::OctetSeq& cpdata, DCPS::GUID_t& dst)
{
  ...
  NDDS::DCPS::Serializer serializer(&buffer,
...
::DDS::Security::ValidationResult_t AuthenticationBuiltInImpl::begin_handshake_reply(
  ...
  ::DDS::Security::SecurityException & ex)
{
  using NDDS::Security::TokenWriter;
  using NDDS::Security::TokenReader;
  ...
  ::DDS::Security::SecurityException & ex)
{
  ...
  if (handshake_data.first && handshake_data.second) {
    ValidationResult_t state = handshake_data.second->state;
    if (state == VALIDATION_OK || state == VALIDATION_OK_FINAL_MESSAGE) {
      NDDS::Security::TokenWriter peer_token(peer_credential_token, Auth_Peer_Cred_Token_Class_Id);
  ...
  DDS::Security::SecurityException & ex)
{
  ...
  NDDS::Security::TokenWriter final_msg(handshake_message_out, build_class_id(Handshake_Final_Class_Ext));
...
bool AuthenticationBuiltInImpl::is_handshake_initiator(
  const NDDS::DCPS::GUID_t& local, const NDDS::DCPS::GUID_t& remote)
{
