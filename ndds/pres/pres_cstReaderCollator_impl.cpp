...
NDDS::DCPS::ReceiveListenerSetMap::~ReceiveListenerSetMap()
{
  DBG_ENTRY_LVL("ReceiveListenerSetMap","~ReceiveListenerSetMap",6);
}

int
NDDS::DCPS::ReceiveListenerSetMap::insert
(RepoId                    publisher_id,
...
int
NDDS::DCPS::ReceiveListenerSetMap::remove(RepoId publisher_id,
                                             RepoId subscriber_id)
{
  DBG_ENTRY_LVL("ReceiveListenerSetMap","remove",6);
  ReceiveListenerSet_rch listener_set;

  if (NDDS::DCPS::find(map_, publisher_id, listener_set) != 0) {
    return 0;
  }
...
int
NDDS::DCPS::ReceiveListenerSetMap::release_subscriber(RepoId publisher_id,
                                                         RepoId subscriber_id)
{
...
void
NDDS::DCPS::ReceiveListenerSetMap::operator= (const ReceiveListenerSetMap& rh)
{
...
void
NDDS::DCPS::ReceiveListenerSetMap::clear()
{
