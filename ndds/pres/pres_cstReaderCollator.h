...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_RECEIVELISTENERSET_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_RECEIVELISTENERSET_H
...
class NDDS_Dcps_Export ReceiveListenerSet :
      public RcObject {
public:
  ...
  typedef NDDS_MAP_CMP(RepoId, TransportReceiveListener_wrch, GUID_tKeyLessThan) MapType;
...
#endif /* NDDS_DCPS_RECEIVELISTENERSET_H */
