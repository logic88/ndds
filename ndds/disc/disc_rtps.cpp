                                          ...
                                          XTypes::TypeLookupService_rch /*tls*/)
{
  ...
  const DCPS::AddDomainStatus ads = {NDDS::DCPS::GUID_UNKNOWN, false /*federated*/};
  return ads;
}
                                   ...
                                   const XTypes::TypeInformation& type_info)
{
  ...
  try {
    ...
    NDDS::DCPS::DataWriterRemote_var dr_remote_obj =
                                    ...
                                    const XTypes::TypeInformation& type_info)
{
  ...
  try {
    ...
    NDDS::DCPS::DataReaderRemote_var dr_remote_obj =
...
ACE_FACTORY_DEFINE(NDDS_InfoRepoDiscovery, IRDiscoveryLoader);
ACE_STATIC_SVC_DEFINE(
  IRDiscoveryLoader,
  ACE_TEXT("NDDS_InfoRepoDiscovery"),
  ACE_SVC_OBJ_T,
