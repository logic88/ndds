...
typedef std::map<DDS::DomainId_t, NDDS::DCPS::RcHandle<DCPS_IR_Domain> > DCPS_IR_Domain_Map;
 ...
 */
class  NDDS_InfoRepoLib_Export TAO_DDS_DCPSInfo_i
  : public virtual POA_NDDS::DCPS::DCPSInfo,
...
public:
   ...
   */
  bool add_topic(const NDDS::DCPS::RepoId& topicId,
                 DDS::DomainId_t domainId,
                 const NDDS::DCPS::RepoId& participantId,
                 const char* topicName,
                 const char* dataTypeName,
...
private:
  ...
  struct BIT_Cleanup_Handler : ACE_Event_Handler
  {
    ...
    NDDS::DCPS::ConditionVariable<ACE_Recursive_Thread_Mutex> cv_;
    bool done_;
  };
