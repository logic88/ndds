...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_DATALINK_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_DATALINK_H
...
typedef NDDS_MAP_CMP(RepoId, DataLinkSet_rch, GUID_tKeyLessThan) DataLinkSetMap;
 ...
 *    is enabled.
 */
class NDDS_Dcps_Export DataLink
...
private:
  ...
  typedef NDDS_MAP_CMP(RepoId, TransportSendListener_wrch, GUID_tKeyLessThan) IdToSendListenerMap;
  IdToSendListenerMap send_listeners_;

  /// Map subscription Id value to TransportReceieveListener.
  typedef NDDS_MAP_CMP(RepoId, TransportReceiveListener_wrch, GUID_tKeyLessThan) IdToRecvListenerMap;
  ...
  typedef NDDS_MAP_CMP(RepoId, ReceiveListenerSet_rch, GUID_tKeyLessThan) AssocByRemote;
  ...
  typedef NDDS_MAP_CMP(RepoId, LocalAssociationInfo, GUID_tKeyLessThan) AssocByLocal;
...
protected:
  ...
  typedef NDDS_MAP_CMP(RepoId, TransportClient_wrch, GUID_tKeyLessThan) RepoToClientMap;
  typedef NDDS_MAP_CMP(RepoId, RepoToClientMap, GUID_tKeyLessThan) OnStartCallbackMap;
  OnStartCallbackMap on_start_callbacks_;
  typedef NDDS_MAP_CMP(RepoId, RepoIdSet, GUID_tKeyLessThan) PendingOnStartsMap;
