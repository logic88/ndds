...
struct SBoundPrinter : UintPrinter<NDDS::XTypes::SBound> {
  explicit SBoundPrinter(const NDDS::XTypes::SBound a_value)
  : UintPrinter<NDDS::XTypes::SBound>(a_value) {}
};

struct LBoundPrinter : UintPrinter<NDDS::XTypes::LBound> {
  explicit LBoundPrinter(const NDDS::XTypes::LBound a_value)
  : UintPrinter<NDDS::XTypes::LBound>(a_value) {}
};

struct EquivalenceKindPrinter : ValuePrinter<NDDS::XTypes::EquivalenceKind> {
  explicit EquivalenceKindPrinter(const NDDS::XTypes::EquivalenceKind a_value)
  : ValuePrinter<NDDS::XTypes::EquivalenceKind>(a_value) {}

  std::ostream& print_on(std::ostream& out) const
  {
    switch (this->value) {
    case NDDS::XTypes::EK_MINIMAL:
      return out << "XTypes::EK_MINIMAL";
    case NDDS::XTypes::EK_COMPLETE:
      return out << "XTypes::EK_COMPLETE";
    case NDDS::XTypes::EK_BOTH:
...
struct MemberFlagPrinter : ValuePrinter<NDDS::XTypes::MemberFlag> {
  explicit MemberFlagPrinter(const NDDS::XTypes::MemberFlag a_value)
  : ValuePrinter<NDDS::XTypes::MemberFlag>(a_value) {}

  std::ostream& print_on(std::ostream& out) const
  {
    BitmaskPrintHelper bph(out);
    if (this->value & NDDS::XTypes::TRY_CONSTRUCT1) {
      bph << "XTypes::TRY_CONSTRUCT1";
    }
    if (this->value & NDDS::XTypes::TRY_CONSTRUCT2) {
      bph << "XTypes::TRY_CONSTRUCT2";
    }
    if (this->value & NDDS::XTypes::IS_EXTERNAL) {
      bph << "XTypes::IS_EXTERNAL";
    }
    if (this->value & NDDS::XTypes::IS_OPTIONAL) {
      bph << "XTypes::IS_OPTIONAL";
    }
    if (this->value & NDDS::XTypes::IS_MUST_UNDERSTAND) {
      bph << "XTypes::IS_MUST_UNDERSTAND";
    }
    if (this->value & NDDS::XTypes::IS_KEY) {
      bph << "XTypes::IS_KEY";
    }
    if (this->value & NDDS::XTypes::IS_DEFAULT) {
...
struct CollectionElementFlagPrinter : MemberFlagPrinter {
  explicit CollectionElementFlagPrinter(const NDDS::XTypes::CollectionElementFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct StructMemberFlagPrinter : MemberFlagPrinter {
  explicit StructMemberFlagPrinter(const NDDS::XTypes::StructMemberFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct UnionMemberFlagPrinter : MemberFlagPrinter {
  explicit UnionMemberFlagPrinter(const NDDS::XTypes::UnionMemberFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct UnionDiscriminatorFlagPrinter : MemberFlagPrinter {
  explicit UnionDiscriminatorFlagPrinter(const NDDS::XTypes::UnionDiscriminatorFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct EnumeratedLiteralFlagPrinter : MemberFlagPrinter {
  explicit EnumeratedLiteralFlagPrinter(const NDDS::XTypes::EnumeratedLiteralFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct AliasMemberFlagPrinter : MemberFlagPrinter {
  explicit AliasMemberFlagPrinter(const NDDS::XTypes::AliasMemberFlag a_value) : MemberFlagPrinter(a_value) {}
};

struct TypeFlagPrinter : ValuePrinter<NDDS::XTypes::TypeFlag> {
  explicit TypeFlagPrinter(const NDDS::XTypes::TypeFlag a_value)
  : ValuePrinter<NDDS::XTypes::TypeFlag>(a_value) {}

  std::ostream& print_on(std::ostream& out) const
  {
    BitmaskPrintHelper bph(out);
    if (this->value & NDDS::XTypes::IS_FINAL) {
      bph << "XTypes::IS_FINAL";
    }
    if (this->value & NDDS::XTypes::IS_APPENDABLE) {
      bph << "XTypes::IS_APPENDABLE";
    }
    if (this->value & NDDS::XTypes::IS_MUTABLE) {
      bph << "XTypes::IS_MUTABLE";
    }
    if (this->value & NDDS::XTypes::IS_NESTED) {
      bph << "XTypes::IS_NESTED";
    }
    if (this->value & NDDS::XTypes::IS_AUTOID_HASH) {
...
struct StructTypeFlagPrinter : TypeFlagPrinter {
  explicit StructTypeFlagPrinter(const NDDS::XTypes::StructTypeFlag a_value) : TypeFlagPrinter(a_value) {}
};

struct UnionTypeFlagPrinter : TypeFlagPrinter {
  explicit UnionTypeFlagPrinter(const NDDS::XTypes::UnionTypeFlag a_value) : TypeFlagPrinter(a_value) {}
};

struct CollectionTypeFlagPrinter : TypeFlagPrinter {
  explicit CollectionTypeFlagPrinter(const NDDS::XTypes::CollectionTypeFlag a_value) : TypeFlagPrinter(a_value) {}
};

struct AliasTypeFlagPrinter : TypeFlagPrinter {
  explicit AliasTypeFlagPrinter(const NDDS::XTypes::AliasTypeFlag a_value) : TypeFlagPrinter(a_value) {}
};

struct EnumTypeFlagPrinter : TypeFlagPrinter {
  explicit EnumTypeFlagPrinter(const NDDS::XTypes::EnumTypeFlag a_value) : TypeFlagPrinter(a_value) {}
};

struct MemberIdPrinter : UintPrinter<NDDS::XTypes::MemberId> {
  explicit MemberIdPrinter(const NDDS::XTypes::MemberId a_value)
  : UintPrinter<NDDS::XTypes::MemberId>(a_value) {}
};

struct BitBoundPrinter : UintPrinter<NDDS::XTypes::BitBound> {
  explicit BitBoundPrinter(const NDDS::XTypes::BitBound a_value)
  : UintPrinter<NDDS::XTypes::BitBound>(a_value) {}
};

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::TypeIdentifier& ti);

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::SBoundSeq& seq)
{
  out << "XTypes::SBoundSeq()";
  for (NDDS::XTypes::SBoundSeq::const_iterator pos = seq.begin(), limit = seq.end(); pos != limit; ++pos) {
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::LBoundSeq& seq)
{
  out << "XTypes::LBoundSeq()";
  for (NDDS::XTypes::LBoundSeq::const_iterator pos = seq.begin(), limit = seq.end(); pos != limit; ++pos) {
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::StringSTypeDefn& string_sdefn)
{
  return out << "XTypes::StringSTypeDefn(" << SBoundPrinter(string_sdefn.bound) << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::StringLTypeDefn& string_ldefn)
{
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainCollectionHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainSequenceSElemDefn& seq_sdefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainSequenceLElemDefn& seq_ldefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainArraySElemDefn& array_sdefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainArrayLElemDefn& array_ldefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainMapSTypeDefn& map_sdefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::PlainMapLTypeDefn& map_ldefn)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::EquivalenceHash& equivalence_hash)
{
  return out
    << "XTypes::EquivalenceHashWrapper("
    << NDDS::XTypes::equivalence_hash_to_string(equivalence_hash)
    << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::TypeObjectHashId& id)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::StronglyConnectedComponentId& scc)
{
  return out
...
operator<<(std::ostream& out, const NDDS::XTypes::TypeIdentifier& ti)
{
  ...
  switch (ti.kind()) {
  case NDDS::XTypes::TK_NONE:
    out << "XTypes::TK_NONE";
    break;
  case NDDS::XTypes::TK_BOOLEAN:
    out << "XTypes::TK_BOOLEAN";
    break;
  case NDDS::XTypes::TK_BYTE:
    out << "XTypes::TK_BYTE";
    break;
  case NDDS::XTypes::TK_INT8:
    out << "XTypes::TK_INT8";
    break;
  case NDDS::XTypes::TK_INT16:
    out << "XTypes::TK_INT16";
    break;
  case NDDS::XTypes::TK_INT32:
    out << "XTypes::TK_INT32";
    break;
  case NDDS::XTypes::TK_INT64:
    out << "XTypes::TK_INT64";
    break;
  case NDDS::XTypes::TK_UINT8:
    out << "XTypes::TK_UINT8";
    break;
  case NDDS::XTypes::TK_UINT16:
    out << "XTypes::TK_UINT16";
    break;
  case NDDS::XTypes::TK_UINT32:
    out << "XTypes::TK_UINT32";
    break;
  case NDDS::XTypes::TK_UINT64:
    out << "XTypes::TK_UINT64";
    break;
  case NDDS::XTypes::TK_FLOAT32:
    out << "XTypes::TK_FLOAT32";
    break;
  case NDDS::XTypes::TK_FLOAT64:
    out << "XTypes::TK_FLOAT64";
    break;
  case NDDS::XTypes::TK_FLOAT128:
    out << "XTypes::TK_FLOAT128";
    break;
  case NDDS::XTypes::TK_CHAR8:
    out << "XTypes::TK_CHAR8";
    break;
  case NDDS::XTypes::TK_CHAR16:
    out << "XTypes::TK_CHAR16";
    break;
  case NDDS::XTypes::TI_STRING8_SMALL:
    out << "XTypes::TI_STRING8_SMALL, " << ti.string_sdefn();
    break;
  case NDDS::XTypes::TI_STRING16_SMALL:
    out << "XTypes::TI_STRING16_SMALL, " << ti.string_sdefn();
    break;
  case NDDS::XTypes::TI_STRING8_LARGE:
    out << "XTypes::TI_STRING8_LARGE, " << ti.string_ldefn();
    break;
  case NDDS::XTypes::TI_STRING16_LARGE:
    out << "XTypes::TI_STRING16_LARGE, " << ti.string_ldefn();
    break;
  case NDDS::XTypes::TI_PLAIN_SEQUENCE_SMALL:
    out << "XTypes::TI_PLAIN_SEQUENCE_SMALL, " << ti.seq_sdefn();
    break;
  case NDDS::XTypes::TI_PLAIN_SEQUENCE_LARGE:
    out << "XTypes::TI_PLAIN_SEQUENCE_LARGE, " << ti.seq_ldefn();
    break;
  case NDDS::XTypes::TI_PLAIN_ARRAY_SMALL:
    out << "XTypes::TI_PLAIN_ARRAY_SMALL, " << ti.array_sdefn();
    break;
  case NDDS::XTypes::TI_PLAIN_ARRAY_LARGE:
    out << "XTypes::TI_PLAIN_ARRAY_LARGE, " << ti.array_ldefn();
    break;
  case NDDS::XTypes::TI_PLAIN_MAP_SMALL:
    out << "XTypes::TI_PLAIN_MAP_SMALL, " << ti.map_sdefn();
    break;
  case NDDS::XTypes::TI_PLAIN_MAP_LARGE:
    out << "XTypes::TI_PLAIN_MAP_LARGE, " << ti.map_ldefn();
    break;
  case NDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT:
...
template<>
std::string getTypeName<NDDS::DCPS::String>()
{
  return "String";
}

template<>
std::string getTypeName<NDDS::XTypes::AppliedAnnotationParameterSeq>()
{
  return "XTypes::AppliedAnnotationParameterSeq";
}

template<>
std::string getTypeName<NDDS::XTypes::AnnotationParameterValue>()
{
  return "XTypes::AnnotationParameterValue";
}

template<>
std::string getTypeName<NDDS::XTypes::AppliedBuiltinMemberAnnotations>()
{
  return "XTypes::AppliedBuiltinMemberAnnotations";
}

template<>
std::string getTypeName<NDDS::XTypes::AppliedAnnotationSeq>()
{
  return "XTypes::AppliedAnnotationSeq";
}

template<>
std::string getTypeName<NDDS::XTypes::AppliedVerbatimAnnotation>()
{
  return "XTypes::AppliedVerbatimAnnotation";
}

template<>
std::string getTypeName<NDDS::XTypes::AppliedBuiltinTypeAnnotations>()
{
  return "XTypes::AppliedBuiltinTypeAnnotations";
}

template<>
std::string getTypeName<NDDS::XTypes::CompleteTypeDetail>()
{
...
template<typename T>
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::Optional<T>& optional)
{
  if (optional.present) {
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedVerbatimAnnotation& ann)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedBuiltinTypeAnnotations& ann)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::NameHash& name_hash)
{
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AnnotationParameterValue& param_value)
{
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedAnnotationParameter& param)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedAnnotationParameterSeq& param_seq)
{
  out << "XTypes::AppliedAnnotationParameterSeq()";
  for (NDDS::XTypes::AppliedAnnotationParameterSeq::const_iterator pos = param_seq.begin();
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedAnnotation& ann)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedAnnotationSeq& ann_seq)
{
  out << "XTypes::AppliedAnnotationSeq()";
  for (NDDS::XTypes::AppliedAnnotationSeq::const_iterator pos = ann_seq.begin();
       pos != ann_seq.end(); ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalAliasHeader&)
{
  return out << "XTypes::MinimalAliasHeader()";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteTypeDetail& detail)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteAliasHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonAliasBody& common)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalAliasBody& body)
{
  return out << "XTypes::MinimalAliasBody(" << body.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::AppliedBuiltinMemberAnnotations& ann)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteAliasBody& body)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalAliasType& alias_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteAliasType& alias_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalTypeDetail&)
{
  return out << "XTypes::MinimalTypeDetail()";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalStructHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteStructHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonStructMember& common)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalMemberDetail& detail)
{
  return out << "XTypes::MinimalMemberDetail(" << detail.name_hash << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteMemberDetail& detail)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalStructMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteStructMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalStructMemberSeq& member_seq)
{
  out << "XTypes::MinimalStructMemberSeq()";
  for (NDDS::XTypes::MinimalStructMemberSeq::const_iterator pos = member_seq.begin();
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteStructMemberSeq& member_seq)
{
  out << "XTypes::CompleteStructMemberSeq()";
  for (NDDS::XTypes::CompleteStructMemberSeq::const_iterator pos = member_seq.begin();
       pos != member_seq.end(); ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalStructType& struct_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteStructType& struct_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonEnumeratedHeader& common)
{
  return out << "XTypes::CommonEnumeratedHeader(" << BitBoundPrinter(common.bit_bound) << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalEnumeratedHeader& header)
{
  return out << "XTypes::MinimalEnumeratedHeader(" << header.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteEnumeratedHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonEnumeratedLiteral& common)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalEnumeratedLiteral& literal)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalEnumeratedLiteralSeq& literal_seq)
{
  out << "XTypes::MinimalEnumeratedLiteralSeq()";
  for (NDDS::XTypes::MinimalEnumeratedLiteralSeq::const_iterator pos = literal_seq.begin(), limit = literal_seq.end(); pos != limit; ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
}
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteEnumeratedLiteral& literal)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteEnumeratedLiteralSeq& literal_seq)
{
  out << "XTypes::CompleteEnumeratedLiteralSeq()";
  for (NDDS::XTypes::CompleteEnumeratedLiteralSeq::const_iterator pos = literal_seq.begin();
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalEnumeratedType& enumerated_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteEnumeratedType& enumerated_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalUnionHeader& header)
{
  return out << "XTypes::MinimalUnionHeader(" << header.detail << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteUnionHeader& header)
{
  return out << "XTypes::CompleteUnionHeader(" << header.detail << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonDiscriminatorMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalDiscriminatorMember& member)
{
  return out << "XTypes::MinimalDiscriminatorMember(" << member.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteDiscriminatorMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::UnionCaseLabelSeq& seq)
{
  out << "XTypes::UnionCaseLabelSeq()";
  for (NDDS::XTypes::UnionCaseLabelSeq::const_iterator pos = seq.begin(), limit = seq.end(); pos != limit; ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
}
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonUnionMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalUnionMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteUnionMember& member)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalUnionMemberSeq& seq)
{
  out << "XTypes::MinimalUnionMemberSeq()";
  for (NDDS::XTypes::MinimalUnionMemberSeq::const_iterator pos = seq.begin(), limit = seq.end(); pos != limit; ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
}
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteUnionMemberSeq& seq)
{
  out << "XTypes::CompleteUnionMemberSeq()";
  for (NDDS::XTypes::CompleteUnionMemberSeq::const_iterator pos = seq.begin();
       pos != seq.end(); ++pos) {
    out << ".append(" << *pos << ")";
  }
  return out;
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalUnionType& union_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteUnionType& union_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonCollectionHeader& header)
{
  return out << "XTypes::CommonCollectionHeader(" << LBoundPrinter(header.bound) << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalCollectionHeader& header)
{
  return out << "XTypes::MinimalCollectionHeader(" << header.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteCollectionHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonCollectionElement& element)
{
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteElementDetail& detail)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalCollectionElement& element)
{
  return out << "XTypes::MinimalCollectionElement(" << element.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteCollectionElement& element)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalSequenceType& sequence_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteSequenceType& sequence_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CommonArrayHeader& header)
{
  return out << "XTypes::CommonArrayHeader(" << header.bound_seq << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalArrayHeader& header)
{
  return out << "XTypes::MinimalArrayHeader(" << header.common << ")";
}

std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteArrayHeader& header)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::MinimalArrayType& array_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteArrayType& array_type)
{
  return out
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::CompleteTypeObject& complete)
{
...
std::ostream&
operator<<(std::ostream& out, const NDDS::XTypes::TypeObject& to)
{
...
{
  static NDDS::DCPS::Encoding enc = NDDS::XTypes::get_typeobject_encoding();
...
typeobject_generator::gen_epilogue()
{
  ...
  size_t idx = 0;
  for (NDDS::XTypes::TypeMap::const_iterator pos = minimal_type_map_.begin();
  ...
  if (produce_xtypes_complete_) {
    idx = 0;
    for (NDDS::XTypes::TypeMap::const_iterator pos = complete_type_map_.begin();
...
typeobject_generator::strong_connect(AST_Type* type, const std::string& anonymous_name)
{
  ...
  case AST_ConcreteType::NT_union:
    {
      ...
      NDDS::XTypes::MemberId member_id = 0;

      for (Fields::Iterator i = fields.begin(); i != fields.end(); ++i) {
        AST_UnionBranch* ub = dynamic_cast<AST_UnionBranch*>(*i);
        const NDDS::XTypes::MemberId id = be_global->compute_id(ub, auto_id, member_id);
        consider(v, ub->field_type(), v.name + "." + NDDS::DCPS::to_dds_string(id));
      }
  ...
  case AST_ConcreteType::NT_struct:
    {
      ...
      for (Fields::Iterator i = fields.begin(); i != fields.end(); ++i) {
        AST_Field* field = *i;
        const NDDS::XTypes::MemberId id = be_global->compute_id(field, auto_id, member_id);
        consider(v, field->field_type(), v.name + "." + NDDS::DCPS::to_dds_string(id));
      }
  ...
  if (v.lowlink == v.index) {
    ...
    if (scc.size() == 1) {
      ...
      NDDS::XTypes::TypeIdentifier minimal_ti(NDDS::XTypes::TI_STRONGLY_CONNECTED_COMPONENT);
      minimal_ti.sc_component_id().sc_component_id.kind = NDDS::XTypes::EK_MINIMAL;
      std::memset(&minimal_ti.sc_component_id().sc_component_id.hash, 0, sizeof(NDDS::XTypes::EquivalenceHash));
      minimal_ti.sc_component_id().scc_length = static_cast<int>(scc.size());

      NDDS::XTypes::TypeIdentifier complete_ti = minimal_ti;
      complete_ti.sc_component_id().sc_component_id.kind = NDDS::XTypes::EK_COMPLETE;
      ...
      NDDS::XTypes::TypeObjectSeq minimal_seq, complete_seq;
      for (List::const_iterator pos = scc.begin(); pos != scc.end(); ++pos) {
        generate_type_identifier(pos->type, true);
        NDDS_ASSERT(type_object_map_.count(pos->type) != 0);
      ...
      const NDDS::DCPS::Encoding& encoding = NDDS::XTypes::get_typeobject_encoding();
      size_t minimal_size = serialized_size(encoding, minimal_seq);
      ACE_Message_Block minimal_buff(minimal_size);
      NDDS::DCPS::Serializer minimal_ser(&minimal_buff, encoding);
      ...
      unsigned char result[sizeof(NDDS::DCPS::MD5Result)];
      NDDS::DCPS::MD5Hash(result, minimal_buff.rd_ptr(), minimal_buff.length());

      // First 14 bytes of MD5 of the serialized TypeObject using XCDR
      // version 2 with Little Endian encoding
      std::memcpy(minimal_ti.sc_component_id().sc_component_id.hash, result, sizeof(NDDS::XTypes::EquivalenceHash));

      size_t complete_size = serialized_size(encoding, complete_seq);
      ACE_Message_Block complete_buff(complete_size);
      NDDS::DCPS::Serializer complete_ser(&complete_buff, encoding);
      ...
      NDDS::DCPS::MD5Hash(result, complete_buff.rd_ptr(), complete_buff.length());
      std::memcpy(complete_ti.sc_component_id().sc_component_id.hash, result, sizeof(NDDS::XTypes::EquivalenceHash));
      ...
      for (List::const_iterator pos = scc.begin(); pos != scc.end(); ++pos) {
        generate_type_identifier(pos->type, true);
        const NDDS::XTypes::TypeIdentifier& minimal_ti = hash_type_identifier_map_[pos->type].minimal;
        const NDDS::XTypes::TypeIdentifier& complete_ti = hash_type_identifier_map_[pos->type].complete;
...
typeobject_generator::update_maps(AST_Type* type,
                                  const NDDS::XTypes::TypeObject& minimal_to,
                                  const NDDS::XTypes::TypeObject& complete_to)
{
  ...
  if (hash_type_identifier_map_.count(type) == 0) {
    const NDDS::XTypes::TypeIdentifier minimal_ti = makeTypeIdentifier(minimal_to, typeid_encoding_);
    const NDDS::XTypes::TypeIdentifier complete_ti = makeTypeIdentifier(complete_to, typeid_encoding_);
    const TypeIdentifierPair ti_pair = {minimal_ti, complete_ti};
...
void typeobject_generator::set_builtin_member_annotations(AST_Decl* member,
  NDDS::XTypes::Optional<NDDS::XTypes::AppliedBuiltinMemberAnnotations>& annotations)
{
...
typeobject_generator::generate_struct_type_identifier(AST_Type* type)
{
  ...
  NDDS::XTypes::TypeObject minimal_to, complete_to;
  minimal_to.kind = NDDS::XTypes::EK_MINIMAL;
  minimal_to.minimal.kind = NDDS::XTypes::TK_STRUCTURE;

  minimal_to.minimal.struct_type.struct_flags = extensibility_to_type_flag(exten);

  if (be_global->is_nested(n)) {
    minimal_to.minimal.struct_type.struct_flags |= NDDS::XTypes::IS_NESTED;
  }

  if (auto_id == autoidkind_hash) {
    minimal_to.minimal.struct_type.struct_flags |= NDDS::XTypes::IS_AUTOID_HASH;
  }

  // TODO: Support inheritance.
  minimal_to.minimal.struct_type.header.base_type = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_NONE);

  complete_to.kind = NDDS::XTypes::EK_COMPLETE;
  complete_to.complete.kind = NDDS::XTypes::TK_STRUCTURE;

  complete_to.complete.struct_type.struct_flags = minimal_to.minimal.struct_type.struct_flags;
  complete_to.complete.struct_type.header.base_type = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_NONE);
  NDDS::DCPS::String name = "::" + scoped_helper(type->name(), "::", EscapeContext_StripEscapes);
  ...
  for (Fields::Iterator i = fields.begin(); i != fields.end(); ++i) {
    ...
    NDDS::XTypes::MinimalStructMember minimal_member;
    ...
    if (be_global->is_optional(field)) {
      minimal_member.common.member_flags |= NDDS::XTypes::IS_OPTIONAL;
    }

    if (be_global->is_must_understand(field)) {
      minimal_member.common.member_flags |= NDDS::XTypes::IS_MUST_UNDERSTAND;
    }

    if (be_global->is_key(field)) {
      minimal_member.common.member_flags |= NDDS::XTypes::IS_KEY;
    }

    if (be_global->is_external(field)) {
      minimal_member.common.member_flags |= NDDS::XTypes::IS_EXTERNAL;
    }

    minimal_member.common.member_type_id = get_minimal_type_identifier(field->field_type());
    NDDS::XTypes::hash_member_name(minimal_member.detail.name_hash, field->local_name()->get_string());
    minimal_to.minimal.struct_type.member_seq.append(minimal_member);

    NDDS::XTypes::CompleteStructMember complete_member;
...
typeobject_generator::generate_union_type_identifier(AST_Type* type)
{
  ...
  NDDS::XTypes::TypeObject minimal_to, complete_to;
  minimal_to.kind = NDDS::XTypes::EK_MINIMAL;
  minimal_to.minimal.kind = NDDS::XTypes::TK_UNION;
  minimal_to.minimal.union_type.union_flags = extensibility_to_type_flag(exten);

  if (be_global->is_nested(n)) {
    minimal_to.minimal.union_type.union_flags |= NDDS::XTypes::IS_NESTED;
  }

  if (auto_id == autoidkind_hash) {
    minimal_to.minimal.union_type.union_flags |= NDDS::XTypes::IS_AUTOID_HASH;
  }
  ...
  if (be_global->union_discriminator_is_key(n)) {
    minimal_to.minimal.union_type.discriminator.common.member_flags |= NDDS::XTypes::IS_KEY;
  }
  minimal_to.minimal.union_type.discriminator.common.type_id = get_minimal_type_identifier(discriminator);

  complete_to.kind = NDDS::XTypes::EK_COMPLETE;
  complete_to.complete.kind = NDDS::XTypes::TK_UNION;
  ...
  for (Fields::Iterator i = fields.begin(); i != fields.end(); ++i) {
    ...
    NDDS::XTypes::MinimalUnionMember minimal_member;
    minimal_member.common.member_id = be_global->get_id(branch);
    minimal_member.common.member_flags = try_construct_to_member_flag(trycon);

    if (is_default) {
      minimal_member.common.member_flags |= NDDS::XTypes::IS_DEFAULT;
    }
    ...
    NDDS::XTypes::hash_member_name(minimal_member.detail.name_hash, branch->local_name()->get_string());
    minimal_to.minimal.union_type.member_seq.append(minimal_member);

    NDDS::XTypes::CompleteUnionMember complete_member;
    complete_member.common.member_id = minimal_member.common.member_id;
    complete_member.common.member_flags = minimal_member.common.member_flags;
...
typeobject_generator::generate_enum_type_identifier(AST_Type* type)
{
  ...
  for (size_t i = 0; i != contents.size(); ++i) {
    NDDS::XTypes::MinimalEnumeratedLiteral minimal_lit;
    minimal_lit.common.value = contents[i]->constant_value()->ev()->u.eval;
    minimal_lit.common.flags = (i == default_literal_idx ? NDDS::XTypes::IS_DEFAULT : 0);
    NDDS::XTypes::hash_member_name(minimal_lit.detail.name_hash, contents[i]->local_name()->get_string());
    minimal_to.minimal.enumerated_type.literal_seq.append(minimal_lit);

    NDDS::XTypes::CompleteEnumeratedLiteral complete_lit;
...
typeobject_generator::generate_array_type_identifier(AST_Type* type, bool force_type_object)
{
  ...
  NDDS::XTypes::CollectionElementFlag cef = try_construct_to_member_flag(trycon);
  if (be_global->is_external(n->base_type())) {
    cef |= NDDS::XTypes::IS_EXTERNAL;
  }
  const NDDS::XTypes::TypeIdentifier minimal_elem_ti = get_minimal_type_identifier(n->base_type());
  const NDDS::XTypes::TypeIdentifier complete_elem_ti = get_complete_type_identifier(n->base_type());

  if (be_global->is_plain(type) && !force_type_object) {
    const NDDS::XTypes::EquivalenceKind minimal_ek =
      NDDS::XTypes::is_fully_descriptive(minimal_elem_ti) ? NDDS::XTypes::EK_BOTH : NDDS::XTypes::EK_MINIMAL;
    const NDDS::XTypes::EquivalenceKind complete_ek =
      minimal_ek == NDDS::XTypes::EK_BOTH ? minimal_ek : NDDS::XTypes::EK_COMPLETE;
    ...
    if (max_bound < 256) {
      NDDS::XTypes::TypeIdentifier minimal_ti(NDDS::XTypes::TI_PLAIN_ARRAY_SMALL);
      ...
      if (minimal_ek == NDDS::XTypes::EK_BOTH) {
        fully_desc_type_identifier_map_[type] = minimal_ti;
      } else {
        NDDS::XTypes::TypeIdentifier complete_ti(NDDS::XTypes::TI_PLAIN_ARRAY_SMALL);
      ...
      NDDS::XTypes::TypeIdentifier minimal_ti(NDDS::XTypes::TI_PLAIN_ARRAY_LARGE);
      ...
      if (minimal_ek == NDDS::XTypes::EK_BOTH) {
        ...
        NDDS::XTypes::TypeIdentifier complete_ti(NDDS::XTypes::TI_PLAIN_ARRAY_LARGE);
    ...
    NDDS::XTypes::TypeObject minimal_to, complete_to;
    minimal_to.kind = NDDS::XTypes::EK_MINIMAL;
    minimal_to.minimal.kind = NDDS::XTypes::TK_ARRAY;
    for (ACE_CDR::ULong dim = 0; dim != n->n_dims(); ++dim) {
    ...
    complete_to.kind = NDDS::XTypes::EK_COMPLETE;
    complete_to.complete.kind = NDDS::XTypes::TK_ARRAY;
...
typeobject_generator::generate_sequence_type_identifier(AST_Type* type, bool force_type_object)
{
  ...
  if (be_global->is_plain(type) && !force_type_object) {
    ...
    const NDDS::XTypes::EquivalenceKind complete_ek =
      minimal_ek == NDDS::XTypes::EK_BOTH ? minimal_ek : NDDS::XTypes::EK_COMPLETE;
    if (bound < 256) {
      NDDS::XTypes::TypeIdentifier minimal_ti(NDDS::XTypes::TI_PLAIN_SEQUENCE_SMALL);
      ...
      if (minimal_ek == NDDS::XTypes::EK_BOTH) {
        ...
        NDDS::XTypes::TypeIdentifier complete_ti(NDDS::XTypes::TI_PLAIN_SEQUENCE_SMALL);
      ...
      NDDS::XTypes::TypeIdentifier minimal_ti(NDDS::XTypes::TI_PLAIN_SEQUENCE_LARGE);
      ...
      if (minimal_ek == NDDS::XTypes::EK_BOTH) {
        ...
        NDDS::XTypes::TypeIdentifier complete_ti(NDDS::XTypes::TI_PLAIN_SEQUENCE_LARGE);
    ...
    NDDS::XTypes::TypeObject minimal_to, complete_to;
    minimal_to.kind = NDDS::XTypes::EK_MINIMAL;
    minimal_to.minimal.kind = NDDS::XTypes::TK_SEQUENCE;
    ...
    complete_to.kind = NDDS::XTypes::EK_COMPLETE;
    complete_to.complete.kind = NDDS::XTypes::TK_SEQUENCE;
...
typeobject_generator::generate_primitive_type_identifier(AST_Type* type)
{
  ...
  case AST_PredefinedType::PT_long:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_INT32);
    break;
  case AST_PredefinedType::PT_ulong:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_UINT32);
    break;
  case AST_PredefinedType::PT_longlong:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_INT64);
    break;
  case AST_PredefinedType::PT_ulonglong:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_UINT64);
    break;
  case AST_PredefinedType::PT_short:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_INT16);
    break;
  case AST_PredefinedType::PT_ushort:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_UINT16);
    break;
#if NDDS_HAS_EXPLICIT_INTS
  case AST_PredefinedType::PT_int8:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_INT8);
    break;
  case AST_PredefinedType::PT_uint8:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_UINT8);
    break;
#endif
  case AST_PredefinedType::PT_float:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_FLOAT32);
    break;
  case AST_PredefinedType::PT_double:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_FLOAT64);
    break;
  case AST_PredefinedType::PT_longdouble:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_FLOAT128);
    break;
  case AST_PredefinedType::PT_char:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_CHAR8);
    break;
  case AST_PredefinedType::PT_wchar:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_CHAR16);
    break;
  case AST_PredefinedType::PT_boolean:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_BOOLEAN);
    break;
  case AST_PredefinedType::PT_octet:
    fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_BYTE);
    break;
...
typeobject_generator::generate_type_identifier(AST_Type* type, bool force_type_object)
{
  ...
  case AST_ConcreteType::NT_string:
    {
      ...
      if (bound < 256) {
        NDDS::XTypes::TypeIdentifier ti(NDDS::XTypes::TI_STRING8_SMALL);
        ti.string_sdefn().bound = bound;
        fully_desc_type_identifier_map_[type] = ti;
      } else {
        NDDS::XTypes::TypeIdentifier ti(NDDS::XTypes::TI_STRING8_LARGE);
  ...
  case AST_ConcreteType::NT_wstring:
    {
      ...
      ACE_CDR::ULong bound = n->max_size()->ev()->u.ulval;
      if (bound < 256) {
        NDDS::XTypes::TypeIdentifier ti(NDDS::XTypes::TI_STRING16_SMALL);
        ti.string_sdefn().bound = bound;
        fully_desc_type_identifier_map_[type] = ti;
      } else {
        NDDS::XTypes::TypeIdentifier ti(NDDS::XTypes::TI_STRING16_LARGE);
        ti.string_ldefn().bound = bound;
        fully_desc_type_identifier_map_[type] = ti;
      }
      break;
  ...
  case AST_ConcreteType::NT_interface_fwd:
    {
      fully_desc_type_identifier_map_[type] = NDDS::XTypes::TypeIdentifier(NDDS::XTypes::TK_NONE);
      break;
    }
...
typeobject_generator::get_minimal_type_identifier(AST_Type* type)
{
  ...
  NDDS_ASSERT(pos != hash_type_identifier_map_.end());
...
typeobject_generator::generate(AST_Type* node, UTL_ScopedName* name)
{
...

  {
    ...
    gti.endArgs();
    const NDDS::XTypes::TypeIdentifier ti = get_minimal_type_identifier(node);
  ...
  if (produce_xtypes_complete_) {
    {
      ...
      if (produce_xtypes_complete_) {
        const NDDS::XTypes::TypeIdentifier ti = get_complete_type_identifier(node);
        be_global->impl_ << common <<
          "    ti = " << ti << ";\n"
          "  }\n"
          "  return ti;\n";
