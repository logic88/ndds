...
private:
  ...
  NDDS::XTypes::TypeIdentifier get_minimal_type_identifier(AST_Type* type);
  NDDS::XTypes::TypeIdentifier get_complete_type_identifier(AST_Type* type);
  ...
  struct TypeObjectPair {
    NDDS::XTypes::TypeObject minimal;
    NDDS::XTypes::TypeObject complete;
  };
  ...
  struct TypeIdentifierPair {
    NDDS::XTypes::TypeIdentifier minimal;
    NDDS::XTypes::TypeIdentifier complete;
  };

  typedef std::map<AST_Type*, TypeIdentifierPair> HashTypeIdentifierMap;
  HashTypeIdentifierMap hash_type_identifier_map_;

  typedef std::map<AST_Type*, NDDS::XTypes::TypeIdentifier> FullyDescriptiveTypeIdentifierMap;
  FullyDescriptiveTypeIdentifierMap fully_desc_type_identifier_map_;

  NDDS::XTypes::TypeMap minimal_type_map_;
  NDDS::XTypes::TypeMap complete_type_map_;
  ...
  NDDS::DCPS::Encoding* typeid_encoding_;
};
