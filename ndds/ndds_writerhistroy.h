...
#ifndef NDDS_DCPS_WRITERINFO_H
#define NDDS_DCPS_WRITERINFO_H
...
class NDDS_Dcps_Export WriterInfoListener
{
public:
  WriterInfoListener();
...
class NDDS_Dcps_Export WriterInfo : public RcObject {
...
public:
  ...
  bool check_end_historic_samples(EndHistoricSamplesMissedSweeper* sweeper, NDDS_MAP(SequenceNumber, ReceivedDataSample)& to_deliver);
...
private:
  ...
  NDDS_MAP(SequenceNumber, ReceivedDataSample) historic_samples_;
  ...
  typedef NDDS_MAP(DDS::InstanceHandle_t, bool) OwnerEvaluateFlags;
...
#endif  /* end of include guard: NDDS_DCPS_WRITERINFO_H */
