...
#ifndef NDDS_DCPS_INTERNAL_TOPIC_H
#define NDDS_DCPS_INTERNAL_TOPIC_H
...
private:
  typedef NDDS_SET(InternalDataWriter_wrch) WriterSet;
  WriterSet writers_;

  typedef NDDS_SET(InternalDataReader_wrch) ReaderSet;
  ReaderSet readers_;
...
#endif // NDDS_DCPS_INTERNAL_TOPIC_H
