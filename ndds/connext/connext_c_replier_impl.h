...
#ifndef NDDS_DCPS_INSTANCESTATE_H
#define NDDS_DCPS_INSTANCESTATE_H
 ...
 * these states.
 */
class NDDS_Dcps_Export InstanceState : public ReactorInterceptor {
public:
  ...
  static NDDS_STRING instance_state_mask_string(DDS::InstanceStateMask mask);
...
#endif /* NDDS_DCPS_INSTANCESTATE_H */
