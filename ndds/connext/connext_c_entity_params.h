...
#ifndef NDDS_DCPS_INSTANCEDATASAMPLELIST_H
#define NDDS_DCPS_INSTANCEDATASAMPLELIST_H
...
*/
class NDDS_Dcps_Export InstanceDataSampleList {
public:
...
#endif  /* NDDS_DCPS_INSTANCEDATASAMPLELIST_H */
