...
#ifndef NDDS_DCPS_RTPS_BASEMESSAGEUTILS_H
#define NDDS_DCPS_RTPS_BASEMESSAGEUTILS_H
...
void marshal_key_hash(const T& msg, KeyHash_t& hash)
{
  ...
  const NDDS::DCPS::SerializedSizeBound bound =
...
class NDDS_Rtps_Export MessageParser {
public:
