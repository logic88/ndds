    ...
    default:
      if (must_understand) {
        if (DCPS_debug_level >= 8) {
          ACE_DEBUG((LM_DEBUG, ACE_TEXT("(%P|%t) unknown must_understand field(%u) in NDDS::XTypes::TypeLookup_getTypes_In\n"), member_id));
        }
        return false;
      }
...
bool operator>>(Serializer& strm, XTypes::TypeLookup_getTypes_Out& stru)
{
  ...
  while (true) {
    ...
    default:
      if (must_understand) {
        if (DCPS_debug_level >= 8) {
          ACE_DEBUG((LM_DEBUG, ACE_TEXT("(%P|%t) unknown must_understand field(%u) in NDDS::XTypes::TypeLookup_getTypes_Out\n"), member_id));
        }
        return false;
      }
      strm.skip(field_size);
...
bool operator>>(Serializer& strm, XTypes::TypeLookup_getTypeDependencies_In& stru)
{
  ...
  while (true) {
    ...
    default:
      if (must_understand) {
        if (DCPS_debug_level >= 8) {
          ACE_DEBUG((LM_DEBUG, ACE_TEXT("(%P|%t) unknown must_understand field(%u) in NDDS::XTypes::TypeLookup_getTypeDependencies_In\n"), member_id));
        }
        return false;
      }
      strm.skip(field_size);
...
bool operator>>(Serializer& strm, XTypes::TypeLookup_getTypeDependencies_Out& stru)
{
  ...
  while (true) {
    ...
    default:
      if (must_understand) {
        if (DCPS_debug_level >= 8) {
          ACE_DEBUG((LM_DEBUG, ACE_TEXT("(%P|%t) unknown must_understand field(%u) in NDDS::XTypes::TypeLookup_getTypeDependencies_Out\n"), member_id));
        }
        return false;
      }
      strm.skip(field_size);
