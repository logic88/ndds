 ...
 *
 */
class NDDS_InfoRepoLib_Export DCPS_IR_Topic
  : public NDDS::DCPS::EnableContainerSupportedUniquePtr<DCPS_IR_Topic>
{
public:
  DCPS_IR_Topic(const NDDS::DCPS::RepoId& id,
  ...
  NDDS::DCPS::RepoId get_id() const;
  NDDS::DCPS::RepoId get_participant_id() const;
