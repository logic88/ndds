...
DCPS_IR_Topic::DCPS_IR_Topic(const NDDS::DCPS::RepoId& id,
                                             ...
                                             , bool associate)
{
  ...
  case 0:
    ...
    if (NDDS::DCPS::DCPS_debug_level > 0) {
      NDDS::DCPS::RepoIdConverter topic_converter(id_);
...
NDDS::DCPS::RepoId DCPS_IR_Topic::get_id() const
{
  return id_;
}

NDDS::DCPS::RepoId DCPS_IR_Topic::get_participant_id() const
{
...
void DCPS_IR_Topic::try_associate(DCPS_IR_Subscription* subscription)
{
  ...
  if (participant_->is_subscription_ignored(subscription->get_id()) ||
    ...
    NDDS::DCPS::IncompatibleQosStatus* qosStatus = 0;
