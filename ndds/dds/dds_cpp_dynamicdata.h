...
#ifndef NDDS_DCPS_RTPS_SEDP_H
#define NDDS_DCPS_RTPS_SEDP_H
...
#ifdef NDDS_SECURITY
typedef NDDS_MAP_CMP(GUID_t, DDS::Security::DatareaderCryptoTokenSeq, GUID_tKeyLessThan)
  DatareaderCryptoTokenSeqMap;
typedef NDDS_MAP_CMP(GUID_t, DDS::Security::DatawriterCryptoTokenSeq, GUID_tKeyLessThan)
...
struct DiscoveredParticipant {
  ...
  typedef NDDS_VECTOR(LocationUpdate) LocationUpdateList;
  ...
  typedef NDDS_LIST(BuiltinAssociationRecord) BuiltinAssociationRecords;
  BuiltinAssociationRecords builtin_pending_records_;
  BuiltinAssociationRecords builtin_associated_records_;
  typedef NDDS_LIST(WriterAssociationRecord_rch) WriterAssociationRecords;
  WriterAssociationRecords writer_pending_records_;
  WriterAssociationRecords writer_associated_records_;
  typedef NDDS_LIST(ReaderAssociationRecord_rch) ReaderAssociationRecords;
...
private:
  ...
  typedef NDDS_MAP_CMP(GUID_t, DiscoveredSubscription,
  ...
  typedef NDDS_MAP_CMP(GUID_t, DiscoveredPublication,
...
private:
  ...
  typedef NDDS_MAP_CMP(GUID_t, LocalPublication,
  ...
  typedef NDDS_MAP_CMP(GUID_t, LocalSubscription,
  ...
  typedef NDDS_MAP_CMP(GUID_t, String, GUID_tKeyLessThan) TopicNameMap;
  ...
  typedef NDDS_MAP(SequenceNumber, TypeIdOrigSeqNumber) OrigSeqNumberMap;
  ...
  public:
    ...
    NDDS_STRING get_instance_name(const DCPS::RepoId& id) const
    {
      const DCPS::RepoId participant = make_id(id, ENTITYID_PARTICIPANT);
      return NDDS_STRING("dds.builtin.TOS.") +
  ...
  protected:
    typedef NDDS_MAP(DCPS::SequenceNumber, DCPS::DataSampleElement*)
      PerReaderDeferredSamples;
    typedef NDDS_MAP(GUID_t, PerReaderDeferredSamples) DeferredSamples;
  ...
  private:
    ...
    typedef NDDS_MAP(XTypes::TypeIdentifier, ContinuationPair) RemoteDependencies;
    ...
    typedef NDDS_MAP(GuidPrefixWrapper, RemoteDependencies) DependenciesMap;
  ...
  typedef NDDS_MAP_CMP(DCPS::RepoId, LocalParticipantMessage,
  ...
  void remove_entities_belonging_to(Map& m, DCPS::RepoId participant, bool subscription, NDDS_VECTOR(typename Map::mapped_type)& to_remove_from_bit);
...
protected:
  ...
  typedef NDDS_MAP(MatchingPair, MatchingData) MatchingDataMap;
  ...
  GUID_t make_topic_guid()
  {
    ...
    guid.entityId.entityKind = DCPS::ENTITYKIND_NDDS_TOPIC;
  ...
  {
    typedef NDDS_MAP_CMP(GUID_t, String, GUID_tKeyLessThan) TNMap;
  ...
  NDDS_SET(String) ignored_topics_;
  NDDS_SET_CMP(GUID_t, GUID_tKeyLessThan) relay_only_readers_;
