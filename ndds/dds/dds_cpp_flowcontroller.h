...
#ifndef NDDS_DCPS_RTPS_SPDP_H
#define NDDS_DCPS_RTPS_SPDP_H
...
{
public:
  typedef NDDS_MAP_CMP(GUID_t, DiscoveredParticipant,
...
private:
...
#ifdef NDDS_SECURITY
  typedef NDDS_MAP_CMP(GUID_t, DDS::Security::AuthRequestMessageToken, GUID_tKeyLessThan)
...
#endif
  {
    ...
    NDDS_LIST(DCPS::RepoId) directed_guids_;
  ...
  typedef NDDS_MULTIMAP(DCPS::MonotonicTimePoint, DCPS::RepoId) TimeQueue;
