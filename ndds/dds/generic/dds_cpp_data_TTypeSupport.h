...
#ifdef NDDS_SECURITY
#ifndef NDDS_DCPS_RTPS_ICE_ENDPOINTMANAGER_H
#define NDDS_DCPS_RTPS_ICE_ENDPOINTMANAGER_H
...
struct EndpointManager : public DCPS::RcObject {
  ...
  {
    NDDS_ASSERT(!transaction_id_to_checklist_.count(a_transaction_id));
  ...
  void unset_responsible_checklist(const STUN::TransactionId& a_transaction_id, ChecklistPtr a_checklist)
  {
    ...
    NDDS_ASSERT(pos != transaction_id_to_checklist_.end());
    NDDS_ASSERT(pos->second == a_checklist);
  ...
  {
    NDDS_ASSERT(!guid_pair_to_checklist_.count(a_guid_pair));
  ...
  void unset_responsible_checklist(const GuidPair& a_guid_pair, ChecklistPtr a_checklist)
  {
    ...
    NDDS_ASSERT(pos != guid_pair_to_checklist_.end());
    NDDS_ASSERT(pos->second == a_checklist);
    ACE_UNUSED_ARG(a_checklist);
  ...
  {
    NDDS_ASSERT(!username_to_checklist_.count(a_username));
  ...
  void unset_responsible_checklist(const std::string& a_username, ChecklistPtr a_checklist)
  {
    ...
    NDDS_ASSERT(pos != username_to_checklist_.end());
    NDDS_ASSERT(pos->second == a_checklist);
    ACE_UNUSED_ARG(a_checklist);
...
#endif /* NDDS_RTPS_ICE_ENDPOINT_MANAGER_H */
#endif /* NDDS_SECURITY */
