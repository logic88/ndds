...
#ifdef NDDS_SECURITY
#ifndef NDDS_DCPS_RTPS_ICE_ICE_H
#define NDDS_DCPS_RTPS_ICE_ICE_H
...
typedef NDDS_VECTOR(ACE_INET_Addr) AddressListType;
...
struct NDDS_Rtps_Export GuidPair {
  DCPS::RepoId local;
  DCPS::RepoId remote;
...
class NDDS_Rtps_Export Endpoint : public virtual DCPS::RcObject {
public:
  virtual ~Endpoint() {}
...
class NDDS_Rtps_Export AgentInfoListener : public virtual DCPS::RcObject {
public:
...
class NDDS_Rtps_Export Configuration {
public:
  Configuration() :
    T_a_(0, 50000),
...
class NDDS_Rtps_Export Agent : public virtual DCPS::RcObject {
public:
  virtual ~Agent() {}
...
class NDDS_Rtps_Export ServerReflexiveStateMachine {
public:
  enum StateChange {
    SRSM_None,
    SRSM_Set,
