...
#ifdef NDDS_SECURITY
#ifndef NDDS_DCPS_RTPS_ICE_CHECKLIST_H
#define NDDS_DCPS_RTPS_ICE_CHECKLIST_H
...
public:
  ...
  bool remove(const FoundationType& a_foundation)
  {
    ...
    NDDS_ASSERT(pos != foundations_.end());
    --pos->second;
...
#endif /* NDDS_RTPS_ICE_CHECKLIST_H */
#endif /* NDDS_SECURITY */
