...
#ifndef NDDS_DCPS_TRANSPORT_MULTICAST_MULTICASTDATALINK_H
#define NDDS_DCPS_TRANSPORT_MULTICAST_MULTICASTDATALINK_H
...
class NDDS_Multicast_Export MulticastDataLink
  : public DataLink {
public:
...
private:
  ...
  typedef NDDS_MAP(MulticastPeer, MulticastSession_rch) MulticastSessionMap;
