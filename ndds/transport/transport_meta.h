...
#ifndef NDDS_DCPS_TRANSPORT_MULTICAST_BESTEFFORTSESSION_H
#define NDDS_DCPS_TRANSPORT_MULTICAST_BESTEFFORTSESSION_H
...
class NDDS_Multicast_Export BestEffortSession
