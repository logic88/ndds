...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDCONTROLELEMENT_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDCONTROLELEMENT_H
...
class NDDS_Dcps_Export TransportSendControlElement : public TransportQueueElement {
public:
...
private:
  ...
  /// The NDDS DCPS header for this control message
...
#endif  /* NDDS_DCPS_TRANSPORTSENDCONTROLELEMENT_H */
