...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDBUFFER_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTSENDBUFFER_H
...
class NDDS_Dcps_Export TransportSendBuffer {
public:
...
class NDDS_Dcps_Export SingleSendBuffer
...
public:
  ...
  void release_all();
  typedef NDDS_VECTOR(BufferType) BufferVec;
  typedef NDDS_MAP(SequenceNumber, BufferType) BufferMap;
  ...
  private:
    ...
    NDDS_DELETED_COPY_MOVE_CTOR_ASSIGN(Proxy)
  };
...
private:
  ...
  typedef NDDS_MAP(SequenceNumber, BufferMap) FragmentMap;
  FragmentMap fragments_;

  typedef NDDS_MAP(SequenceNumber, RepoId) DestinationMap;
  DestinationMap destinations_;

  typedef NDDS_SET(SequenceNumber) SequenceNumberSet;
