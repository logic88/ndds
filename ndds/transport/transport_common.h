...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTQUEUEELEMENT_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTQUEUEELEMENT_H
...
extern NDDS_Dcps_Export const TqePair null_tqe_pair;
typedef NDDS_VECTOR(TransportQueueElement*) TqeVector;
 ...
 */
class NDDS_Dcps_Export TransportQueueElement : public PoolAllocationBase {
public:

  virtual ~TransportQueueElement();

  class NDDS_Dcps_Export MatchCriteria {
  protected:
  ...
  class NDDS_Dcps_Export MatchOnPubId : public MatchCriteria {
  public:
  ...
  class NDDS_Dcps_Export MatchOnDataPayload : public MatchCriteria {
  public:
  ...
  class NDDS_Dcps_Export MatchOnElement : public MatchCriteria {
  public:
...
#endif  /* NDDS_DCPS_TRANSPORTQUEUEELEMENT_H */
