...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTRECEIVESTRATEGY_T_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_TRANSPORTRECEIVESTRATEGY_T_H
...
struct NDDS_Dcps_Export TransportReceiveConstants { // non-template base for constants only
  //
...
#endif /* NDDS_DCPS_TRANSPORTRECEIVESTRATEGY */
