...
#ifndef NDDS_DCPS_NETWORK_ADDRESS_H
#define NDDS_DCPS_NETWORK_ADDRESS_H
...
class NDDS_Dcps_Export NetworkAddress {
public:
  NetworkAddress();
...
typedef NDDS_SET(NetworkAddress) AddrSet;
...
#endif /*NDDS_DCPS_NETWORK_ADDRESS_H*/
