...
#ifndef NDDS_DCPS_MEMORYPOOL_H
#define NDDS_DCPS_MEMORYPOOL_H
...
class NDDS_Dcps_Export AllocHeader {
public:
  /** Construct */
  AllocHeader();
...
class NDDS_Dcps_Export FreeHeader : public AllocHeader {
public:
...
class NDDS_Dcps_Export FreeIndex {
...
class NDDS_Dcps_Export MemoryPool {
  friend class Test::MemoryPoolTest;
public:
