...
#ifndef NDDS_NO_OBJECT_MODEL_PROFILE
  change_depth_(0),
#endif
    ...
    DDS::StatusMask             mask)
{
  ...
  NDDS::DCPS::TypeSupport_ptr typesupport =
...
PublisherImpl::set_qos(const DDS::PublisherQos & qos)
{
  ...
  NDDS_NO_OBJECT_MODEL_PROFILE_COMPATIBILITY_CHECK(qos, DDS::RETCODE_UNSUPPORTED);
...
#endif // NDDS_NO_OBJECT_MODEL_PROFILE
    ...
    const DDS::Duration_t& max_wait)
{
  ...
  typedef NDDS_MAP(DataWriterImpl*, DataWriterImpl::AckToken) DataWriterAckMap;
    ...
    DDS::DataWriterQos&       dw_qos)
{
  ...
  NDDS_NO_OWNERSHIP_KIND_EXCLUSIVE_COMPATIBILITY_CHECK(dw_qos, DDS::DataWriter::_nil());
  NDDS_NO_OWNERSHIP_STRENGTH_COMPATIBILITY_CHECK(dw_qos, DDS::DataWriter::_nil());
  NDDS_NO_OWNERSHIP_PROFILE_COMPATIBILITY_CHECK(dw_qos, DDS::DataWriter::_nil());
  NDDS_NO_DURABILITY_SERVICE_COMPATIBILITY_CHECK(dw_qos, DDS::DataWriter::_nil());
  NDDS_NO_DURABILITY_KIND_TRANSIENT_PERSISTENT_COMPATIBILITY_CHECK(dw_qos, DDS::DataWriter::_nil());
