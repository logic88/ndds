...
bool ts_generator::generate_ts(AST_Decl* node, UTL_ScopedName* name)
{
  ...
  be_global->header_ <<
    ...
    "  typedef " << cxxName << "_NDDS_KeyLessThan LessThanType;\n"
    "  typedef NDDS::DCPS::KeyOnly<const " << cxxName << "> KeyOnlyType;\n"
    "\n"
  ...
  be_global->header_ << be_global->versioning_begin() << "\n";
  {
    ...
    be_global->header_ <<
      ...
      "  : public virtual NDDS::DCPS::LocalObject<" << ts_short_name << "TypeSupport>\n"
      "  , public virtual NDDS::DCPS::TypeSupportImpl\n"
      "{\n"
      "public:\n"
      "  typedef NDDS::DCPS::DDSTraits<" << short_name << "> TraitsType;\n"
      "  typedef NDDS::DCPS::MarshalTraits<" << short_name << "> MarshalTraitsType;\n"
      ...
      "  virtual const NDDS::DCPS::MetaStruct& getMetaStructForType();\n"
      "#endif /* !NDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */\n"
      "  virtual bool has_dcps_key();\n"
      "  const char* default_type_name() const;\n"
      "\n"
      "  void representations_allowed_by_type(::DDS::DataRepresentationIdSeq& seq);\n"
      "\n"
      "  virtual const NDDS::XTypes::TypeIdentifier& getMinimalTypeIdentifier() const;\n"
      "  virtual const NDDS::XTypes::TypeMap& getMinimalTypeMap() const;\n"
      "\n"
      "  virtual const NDDS::XTypes::TypeIdentifier& getCompleteTypeIdentifier() const;\n"
      "  virtual const NDDS::XTypes::TypeMap& getCompleteTypeMap() const;\n"
      "\n"
      "  virtual NDDS::DCPS::Extensibility getExtensibility() const;\n"
      "\n"
  ...
  be_global->impl_ << be_global->versioning_begin() << "\n";
  {
    ...
    be_global->impl_ <<
      ...
      "{\n"
      "  typedef NDDS::DCPS::DataWriterImpl_T<" << short_name << "> DataWriterImplType;\n"
      ...
      "{\n"
      "  typedef NDDS::DCPS::DataReaderImpl_T<" << short_name << "> DataReaderImplType;\n"
      ...
      "{\n"
      "  typedef NDDS::DCPS::DataReaderImpl_T<" << short_name << "> DataReaderImplType;\n"
      "  typedef NDDS::DCPS::MultiTopicDataReader_T<" << short_name << ", DataReaderImplType> MultiTopicDataReaderImplType;\n"
      ...
      "#endif /* !NDDS_NO_MULTI_TOPIC */\n\n"
      "#ifndef NDDS_NO_CONTENT_SUBSCRIPTION_PROFILE\n"
      "const NDDS::DCPS::MetaStruct& " << ts_short_name << "TypeSupportImpl::getMetaStructForType()\n"
      "{\n"
      "  return NDDS::DCPS::getMetaStruct<" << short_name << ">();\n"
      "}\n"
      "#endif /* !NDDS_NO_CONTENT_SUBSCRIPTION_PROFILE */\n\n"
      ...
      "}\n"
      "\n"
      "const NDDS::XTypes::TypeIdentifier& " << ts_short_name << "TypeSupportImpl::getMinimalTypeIdentifier() const\n"
      "{\n";
    ...
    if (generate_xtypes) {
      be_global->impl_ <<
        "  return NDDS::DCPS::getMinimalTypeIdentifier<NDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n";
    } else {
      be_global->impl_ <<
        "  static NDDS::XTypes::TypeIdentifier ti;\n"
        "  return ti;\n";
    }
    be_global->impl_ <<
      "}\n\n"
      "const NDDS::XTypes::TypeMap& " << ts_short_name << "TypeSupportImpl::getMinimalTypeMap() const\n"
      "{\n";

    if (generate_xtypes) {
      be_global->impl_ <<
        "  return NDDS::DCPS::getMinimalTypeMap<NDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n";
    } else {
      be_global->impl_ <<
        "  static NDDS::XTypes::TypeMap tm;\n"
        "  return tm;\n";
    }
    be_global->impl_ <<
      "}\n\n"
      "const NDDS::XTypes::TypeIdentifier& " << ts_short_name << "TypeSupportImpl::getCompleteTypeIdentifier() const\n"
      "{\n";

    const bool generate_xtypes_complete = generate_xtypes && be_global->xtypes_complete();
    if (generate_xtypes_complete) {
      be_global->impl_ <<
        "  return NDDS::DCPS::getCompleteTypeIdentifier<NDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n";
    } else {
      be_global->impl_ <<
        "  static NDDS::XTypes::TypeIdentifier ti;\n"
        "  return ti;\n";
    ...
    be_global->impl_ <<
      "}\n\n"
      "const NDDS::XTypes::TypeMap& " << ts_short_name << "TypeSupportImpl::getCompleteTypeMap() const\n"
      "{\n";

    if (generate_xtypes_complete) {
      be_global->impl_ <<
        "  return NDDS::DCPS::getCompleteTypeMap<NDDS::DCPS::" << typeobject_generator::tag_type(name) << ">();\n";
    } else {
      be_global->impl_ <<
        "  static NDDS::XTypes::TypeMap tm;\n"
        "  return tm;\n";
    ...
    be_global->impl_ <<
      "}\n\n"
      "NDDS::DCPS::Extensibility " << ts_short_name << "TypeSupportImpl::getExtensibility() const\n"
      "{\n"
...
namespace face_ts_generator {
  ...
  void generate(UTL_ScopedName* name) {
    ...
    be_global->facets_impl_ <<
      ...
      "  NDDS::FaceTSS::receive_message(connection_id, timeout,\n"
      ...
      "                  MESSAGE_SIZE_TYPE& message_size,\n"
      "                  RETURN_CODE_TYPE& return_code) {\n"
      "  NDDS::FaceTSS::send_message(connection_id, timeout,\n"
      "                                 transaction_id, message,\n"
      "                                 message_size, return_code);\n"
      "}\n\n"
      ...
      "                       RETURN_CODE_TYPE& return_code) {\n"
      "  NDDS::FaceTSS::register_callback(connection_id, waitset,\n"
      "                                      data_callback,\n"
