...
#ifndef NDDS_DCPS_MARKED_DEFAULT_QOS_H
#define NDDS_DCPS_MARKED_DEFAULT_QOS_H
...
*/
class NDDS_Dcps_Export Marked_Default_Qos {
public:
...
#define PARTICIPANT_QOS_DEFAULT     \
  NDDS::DCPS::Marked_Default_Qos::marked_default_DomainParticipantQos ()
#define TOPIC_QOS_DEFAULT           \
  NDDS::DCPS::Marked_Default_Qos::marked_default_TopicQos ()
#define PUBLISHER_QOS_DEFAULT       \
  NDDS::DCPS::Marked_Default_Qos::marked_default_PublisherQos ()
#define SUBSCRIBER_QOS_DEFAULT      \
  NDDS::DCPS::Marked_Default_Qos::marked_default_SubscriberQos ()
#define DATAWRITER_QOS_DEFAULT      \
  NDDS::DCPS::Marked_Default_Qos::marked_default_DataWriterQos ()
#define DATAREADER_QOS_DEFAULT      \
  NDDS::DCPS::Marked_Default_Qos::marked_default_DataReaderQos ()
#define DATAWRITER_QOS_USE_TOPIC_QOS    \
  NDDS::DCPS::Marked_Default_Qos::marked_default_DataWriter_Use_TopicQos ()
#define DATAREADER_QOS_USE_TOPIC_QOS    \
  NDDS::DCPS::Marked_Default_Qos::marked_default_DataReader_Use_TopicQos ()
...
#endif /* NDDS_DCPS_MARKED_DEFAULT_QOS_H */
