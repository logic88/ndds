 ...
 *
 * NDDS-specific annotations should go in the NDDS C++ namespace and the
 * NDDS IDL module. Only standardized annotations should be outside those
 * scopes.
 */

#ifndef NDDS_IDL_ANNOTATIONS_HEADER
#define NDDS_IDL_ANNOTATIONS_HEADER
...
// NDDS Specific Annotations
NDDS_BEGIN_VERSIONED_NAMESPACE_DECL
namespace NDDS {

  // @NDDS::data_representation ===========================================
