...
#ifndef NDDS_DCPS_PUBLISHER_IMPL_H
#define NDDS_DCPS_PUBLISHER_IMPL_H
...
* @class PublisherImpl
*
* @brief Implements the NDDS::DCPS::Publisher interfaces.
*
...
*/
class NDDS_Dcps_Export PublisherImpl
...
public:
  ...
  */
  ...
  typedef NDDS_VECTOR(PublicationId) PublicationIdVec;
...
private:
  typedef NDDS_MULTIMAP(NDDS_STRING, DataWriterImpl_rch) DataWriterMap;

  typedef NDDS_MAP_CMP(PublicationId, DataWriterImpl_rch, GUID_tKeyLessThan)
    PublicationMap;

  // DataWriter id to qos map.
  typedef NDDS_MAP_CMP(RepoId, DDS::DataWriterQos, GUID_tKeyLessThan) DwIdToQosMap;
  ...
  typedef NDDS_SET(DataWriterImpl_rch) DataWriterSet;
...
#endif /* NDDS_DCPS_PUBLISHER_IMPL_H  */
