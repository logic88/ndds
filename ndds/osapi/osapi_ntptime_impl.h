...
#ifndef NDDS_DCPS_NETWORK_RESOURCE_H
#define NDDS_DCPS_NETWORK_RESOURCE_H
...
typedef NDDS_VECTOR(HostnameInfo) HostnameInfoVector;
 ...
 */
struct NDDS_Dcps_Export NetworkResource {
  NetworkResource();
...
extern NDDS_Dcps_Export
ACE_INET_Addr choose_single_coherent_address(const NDDS_VECTOR(ACE_INET_Addr)& addrs, bool prefer_loopback = true, const String& name = String());
...
#endif /* NDDS_DCPS_NETWORK_RESOURCE_H */
