...
struct FaceGenerator : GeneratorBase
{
  virtual void init()
  {
    ...
    helpers_[HLP_STR_MGR] = "::NDDS::FaceTypes::String_mgr";
    helpers_[HLP_WSTR_MGR] = "::NDDS::FaceTypes::WString_mgr";
    helpers_[HLP_FIX_VAR] = "::TAO_Fixed_Var_T";
    helpers_[HLP_VAR_VAR] = "::TAO_Var_Var_T";
    helpers_[HLP_OUT] = "::TAO_Out_T";
    helpers_[HLP_SEQ] = "::NDDS::FaceTypes::Sequence";
    helpers_[HLP_SEQ_NS] = "::NDDS::FaceTypes";
    helpers_[HLP_SEQ_VAR_VAR] = "::NDDS::FaceTypes::SequenceVar";
    helpers_[HLP_SEQ_FIX_VAR] = "::NDDS::FaceTypes::SequenceVar";
    ...
    helpers_[HLP_FIXED] = "::NDDS::FaceTypes::Fixed_T";
    helpers_[HLP_FIXED_CONSTANT] = "::NDDS::FaceTypes::Fixed";
  }
...
struct SafetyProfileGenerator : GeneratorBase
{
  virtual void init()
  {
    ...
    helpers_[HLP_VAR_VAR] = "::TAO_Var_Var_T";
    helpers_[HLP_OUT] = "::TAO_Out_T";
    helpers_[HLP_SEQ] = "::NDDS::SafetyProfile::Sequence";
    helpers_[HLP_SEQ_NS] = "::NDDS::SafetyProfile";
    helpers_[HLP_SEQ_VAR_VAR] = "::NDDS::SafetyProfile::SequenceVar";
    helpers_[HLP_SEQ_FIX_VAR] = "::NDDS::SafetyProfile::SequenceVar";
    helpers_[HLP_SEQ_OUT] = "::TAO_Seq_Out_T";
    helpers_[HLP_ARR_VAR_VAR] = "::TAO_VarArray_Var_T";
    helpers_[HLP_ARR_FIX_VAR] = "::TAO_FixedArray_Var_T";
    helpers_[HLP_ARR_OUT] = "::TAO_Array_Out_T";
