  ...
  const NDDS::DCPS::RepoId& participantId)
{
  ...
  if (where == this->domains_.end()) {
    throw NDDS::DCPS::Invalid_Domain();
  }
  ...
  if (0 == participant) {
    throw NDDS::DCPS::Invalid_Participant();
  }
...
NDDS::DCPS::TopicStatus TAO_DDS_DCPSInfo_i::assert_topic(
...
{
  ACE_GUARD_RETURN(ACE_Recursive_Thread_Mutex, guard, this->lock_, NDDS::DCPS::INTERNAL_ERROR);
  // Grab the domain.
  DCPS_IR_Domain_Map::iterator where = this->domains_.find(domainId);
  ...
  NDDS::DCPS::TopicStatus topicStatus
  ...
  if (this->um_ && (participantPtr->isBitPublisher() == false)) {
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(topicId);
      ACE_DEBUG((LM_DEBUG,
...
bool
TAO_DDS_DCPSInfo_i::add_topic(const NDDS::DCPS::RepoId& topicId,
                              DDS::DomainId_t domainId,
                              const NDDS::DCPS::RepoId& participantId,
                              const char* topicName,
                              const char* dataTypeName,
                              const DDS::TopicQos& qos)
{
  ...
  if (0 == participantPtr) {
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(participantId);
      ACE_DEBUG((LM_WARNING,
                 ACE_TEXT("(%P|%t) WARNING: TAO_DDS_DCPSInfo_i:add_topic: ")
  ...
  if (topicStatus != NDDS::DCPS::CREATED) {
    return false;
  }
...
NDDS::DCPS::TopicStatus TAO_DDS_DCPSInfo_i::find_topic(
  DDS::DomainId_t domainId,
  const char * topicName,
  ...
  NDDS::DCPS::RepoId_out topicId)
{
  ...
  NDDS::DCPS::TopicStatus status = NDDS::DCPS::NOT_FOUND;
...
NDDS::DCPS::TopicStatus TAO_DDS_DCPSInfo_i::remove_topic(
  DDS::DomainId_t domainId,
  const NDDS::DCPS::RepoId& participantId,
  const NDDS::DCPS::RepoId& topicId)
{
  ...
  if (partPtr->find_topic_reference(topicId, topic) != 0) {
    throw NDDS::DCPS::Invalid_Topic();
  }

  NDDS::DCPS::TopicStatus removedStatus = where->second->remove_topic(partPtr, topic);
...
NDDS::DCPS::RepoId TAO_DDS_DCPSInfo_i::add_publication(
  DDS::DomainId_t domainId,
  const NDDS::DCPS::RepoId& participantId,
  const NDDS::DCPS::RepoId& topicId,
  NDDS::DCPS::DataWriterRemote_ptr publication,
  ...
  const DDS::OctetSeq& serializedTypeInfo)
{
  if (CORBA::is_nil(publication)) {
    ...
    return NDDS::DCPS::GUID_UNKNOWN;
  }

  ACE_GUARD_RETURN(ACE_Recursive_Thread_Mutex, guard, this->lock_, NDDS::DCPS::GUID_UNKNOWN);
  ...
  NDDS::DCPS::RepoId pubId = partPtr->get_next_publication_id(
    NDDS::DCPS::RepoIdConverter(topicId).isBuiltinDomainEntity());

  NDDS::DCPS::DataWriterRemote_var dispatchingPublication =
    NDDS::DCPS::DataWriterRemote::_duplicate(publication);
  ...
  if (dispatchingOrb_) {
    ...
    dispatchingPublication = NDDS::DCPS::DataWriterRemote::_unchecked_narrow(pubObj);
  }

  NDDS::DCPS::unique_ptr<DCPS_IR_Publication> pubPtr(
  ...
  if (partPtr->add_publication(NDDS::DCPS::move(pubPtr)) != 0) {
    // failed to add.  we are responsible for the memory.
    pubId = NDDS::DCPS::GUID_UNKNOWN;
  ...
  if (this->um_ && (partPtr->isBitPublisher() == false)) {
    ...
    Update::UWActor actor(domainId, pubId, topicId, participantId, Update::DataWriter
                          ...
                          , const_cast<NDDS::DCPS::TransportLocatorSeq&>(transInfo)
                          , transportContextDefault, csi
                          , const_cast<DDS::OctetSeq&>(serializedTypeInfo));
    this->um_->create(actor);

    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(pubId);
      ACE_DEBUG((LM_DEBUG,
                                    ...
                                    bool associate)
{
  ...
  NDDS::DCPS::DataWriterRemote_var publication = NDDS::DCPS::DataWriterRemote::_unchecked_narrow(obj.in());
  ...
  const NDDS::DCPS::RepoId& publicationId)
{
  ...
  if (partPtr->remove_publication(publicationId) != 0) {
    ...
    throw NDDS::DCPS::Invalid_Publication();
  }
  ...
  if (this->um_
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(publicationId);
      ACE_DEBUG((LM_DEBUG,
...
NDDS::DCPS::RepoId TAO_DDS_DCPSInfo_i::add_subscription(
  DDS::DomainId_t domainId,
  const NDDS::DCPS::RepoId& participantId,
  const NDDS::DCPS::RepoId& topicId,
  NDDS::DCPS::DataReaderRemote_ptr subscription,
  ...
  const DDS::OctetSeq & serializedTypeInfo)
{
  ...
  NDDS::DCPS::unique_ptr<DCPS_IR_Subscription> subPtr;
  {
    ACE_GUARD_RETURN(ACE_Recursive_Thread_Mutex, guard, this->lock_, NDDS::DCPS::GUID_UNKNOWN);
    ...
    NDDS::DCPS::DataReaderRemote_var dispatchingSubscription (
      NDDS::DCPS::DataReaderRemote::_duplicate(subscription));
    ...
    if (dispatchingOrb_) {
      ...
      dispatchingSubscription = NDDS::DCPS::DataReaderRemote::_unchecked_narrow(subObj);
    }
  ...
  if (this->um_ && (partPtr->isBitPublisher() == false)) {
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(subId);
      ACE_DEBUG((LM_DEBUG,
  ...
  bool associate)
{
  ...
  NDDS::DCPS::DataReaderRemote_var subscription = NDDS::DCPS::DataReaderRemote::_unchecked_narrow(obj.in());
  ...
  DCPS_IR_Subscription* sub = subPtr.get();
  switch (partPtr->add_subscription(NDDS::DCPS::move(subPtr))) {
  case -1: {
    NDDS::DCPS::RepoIdConverter converter(subId);
    ACE_ERROR((LM_ERROR,
  ...
  const NDDS::DCPS::RepoId& subscriptionId)
{
  ...
  if (partPtr->remove_subscription(subscriptionId) != 0) {
    ...
    throw NDDS::DCPS::Invalid_Subscription();
  }
  ...
  if (this->um_
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(subscriptionId);
      ACE_DEBUG((LM_DEBUG,
...
NDDS::DCPS::AddDomainStatus TAO_DDS_DCPSInfo_i::add_domain_participant(
  DDS::DomainId_t domain,
  const DDS::DomainParticipantQos & qos)
{
  // A value to return.
  NDDS::DCPS::AddDomainStatus value;
  value.id        = NDDS::DCPS::GUID_UNKNOWN;
  ...
  NDDS::DCPS::RepoId participantId = domainPtr->get_next_participant_id();
  ...
  DCPS_IR_Participant_rch participant =
    NDDS::DCPS::make_rch<DCPS_IR_Participant>(
                   this->federation_,
                   participantId,
                   domainPtr,
                   qos, um_, isBitPart);
  ...
  if (0 != status) {
    ...
    participantId = NDDS::DCPS::GUID_UNKNOWN;
                                           ...
                                           , const DDS::DomainParticipantQos & qos)
{
  ...
  DCPS_IR_Participant_rch participant =
    NDDS::DCPS::make_rch<DCPS_IR_Participant>(this->federation_,
                                     participantId,
                                     domainPtr,
                                     qos, um_, isBitPart);
  ...
  long              owner)
{
  ...
  std::vector<NDDS::DCPS::RepoId> candidates;
  ...
  for (unsigned int index = 0; index < candidates.size(); ++index) {
    ...
    if (participant) {
      std::vector<NDDS::DCPS::RepoId> keylist;
      ...
      if (NDDS::DCPS::DCPS_debug_level > 0) {
        NDDS::DCPS::RepoIdConverter converter(candidates[index]);
        ACE_DEBUG((LM_DEBUG,
          ACE_TEXT("(%P|%t) (bool)TAO_DDS_DCPSInfo_i::remove_by_owner: ")
...
TAO_DDS_DCPSInfo_i::disassociate_participant(
  DDS::DomainId_t domainId,
  const NDDS::DCPS::RepoId& local_id,
  const NDDS::DCPS::RepoId& remote_id)
{
  ACE_GUARD(ACE_Recursive_Thread_Mutex, guard, this->lock_);
  ...
  const NDDS::DCPS::RepoId& remote_id)
{
  ...
  if (NDDS::DCPS::DCPS_debug_level > 3) {
  ...
  if (participant->find_subscription_reference(local_id, subscription)
      != 0 || subscription == 0) {
    NDDS::DCPS::RepoIdConverter part_converter(participantId);
    NDDS::DCPS::RepoIdConverter sub_converter(local_id);
    ACE_ERROR((LM_ERROR,
  ...
  const NDDS::DCPS::RepoId& remote_id)
{
  ...
  if (participant->find_publication_reference(local_id, publication)
      != 0 || publication == 0) {
    NDDS::DCPS::RepoIdConverter part_converter(participantId);
    NDDS::DCPS::RepoIdConverter pub_converter(local_id);
    ACE_ERROR((LM_ERROR,
  ...
  const NDDS::DCPS::RepoId& participantId)
{
  ...
  if (where->second->participants().empty()
    ...
    using NDDS::DCPS::CvStatus_NoTimeout;
    NDDS::DCPS::CvStatus status = CvStatus_NoTimeout;
    NDDS::DCPS::ThreadStatusManager& thread_status_manager = TheServiceParticipant->get_thread_status_manager();
  ...
  const DDS::PublisherQos & publisherQos)
{
  ...
  if (partPtr->find_publication_reference(dwId, pub) != 0 || pub == 0) {
    NDDS::DCPS::RepoIdConverter part_converter(partId);
    NDDS::DCPS::RepoIdConverter pub_converter(dwId);
    ACE_ERROR((LM_ERROR,
  ...
  if (this->um_ && (partPtr->isBitPublisher() == false)) {
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(dwId);
      ACE_DEBUG((LM_DEBUG,
  ...
  const DDS::SubscriberQos & subscriberQos)
{
  ...
  if (partPtr->find_subscription_reference(drId, sub) != 0 || sub == 0) {
    NDDS::DCPS::RepoIdConverter part_converter(partId);
    NDDS::DCPS::RepoIdConverter sub_converter(drId);
    ACE_ERROR((LM_ERROR,
  ...
  if (this->um_ && (partPtr->isBitPublisher() == false)) {
    ...
    if (NDDS::DCPS::DCPS_debug_level > 4) {
      NDDS::DCPS::RepoIdConverter converter(drId);
      ACE_DEBUG((LM_DEBUG,
    ...
    const DDS::StringSeq& params)
{
  ...
  if (partPtr->find_subscription_reference(subscriptionId, sub) != 0) {
    NDDS::DCPS::RepoIdConverter part_converter(participantId);
    NDDS::DCPS::RepoIdConverter sub_converter(subscriptionId);
    ACE_ERROR((LM_ERROR,
...
{
  if (domain == NDDS::DCPS::Service_Participant::ANY_DOMAIN) {
    ACE_ERROR((LM_ERROR,
  ...
  if (where == this->domains_.end()) {
    ...
    NDDS::DCPS::unique_ptr<DCPS_IR_Domain> domain_uptr( new
    ...
    this->domains_.insert(
      where,
      DCPS_IR_Domain_Map::value_type(domain, NDDS::DCPS::move(domain_uptr)));
                                       ...
                                       const char* listen_str)
{
  ...
  try {
    ...
    if (ACE_Service_Config::current()->find(ACE_TEXT("NDDS_Tcp"))
        < 0 /* not found (-1) or suspended (-2) */) {
      static const ACE_TCHAR directive[] =
        ACE_TEXT("dynamic NDDS_Tcp Service_Object * ")
        ACE_TEXT("NDDS_Tcp:_make_TcpLoader()");
      ACE_Service_Config::process_directive(directive);
    }
#endif

    const std::string config_name =
      NDDS::DCPS::TransportRegistry::DEFAULT_INST_PREFIX
      + std::string("InfoRepoBITTransportConfig");
    NDDS::DCPS::TransportConfig_rch config =
      NDDS::DCPS::TransportRegistry::instance()->create_config(config_name);

    const std::string inst_name =
      NDDS::DCPS::TransportRegistry::DEFAULT_INST_PREFIX
      + std::string("InfoRepoBITTCPTransportInst");
    NDDS::DCPS::TransportInst_rch inst =
      NDDS::DCPS::TransportRegistry::instance()->create_inst(inst_name,
                                                               "tcp");
    config->instances_.push_back(inst);

    NDDS::DCPS::TcpInst_rch tcp_inst =
      NDDS::DCPS::dynamic_rchandle_cast<NDDS::DCPS::TcpInst>(inst);
...
TAO_DDS_DCPSInfo_i::receive_image(const Update::UImage& image)
{
  ...
  for (Update::UImage::ParticipantSeq::const_iterator
    ...
    if (!this->add_domain_participant(part->domainId, part->participantId
                                      , part->participantQos)) {
      NDDS::DCPS::RepoIdConverter converter(part->participantId);
      ACE_ERROR((LM_ERROR,
    ...
    } else if (NDDS::DCPS::DCPS_debug_level > 0) {
      NDDS::DCPS::RepoIdConverter converter(part->participantId);
      ACE_DEBUG((LM_DEBUG,
                 ACE_TEXT("(%P|%t) TAO_DDS_DCPSInfo_i::receive_image: ")
  ...
  for (Update::UImage::TopicSeq::const_iterator iter = image.topics.begin();
    ...
    if (!this->add_topic(topic->topicId, topic->domainId
      ...
      NDDS::DCPS::RepoIdConverter topic_converter(topic->topicId);
      NDDS::DCPS::RepoIdConverter part_converter(topic->participantId);
      ACE_ERROR((LM_ERROR,
                 ACE_TEXT("(%P|%t) ERROR: TAO_DDS_DCPSInfo_i::receive_image: ")
  ...
  for (Update::UImage::ReaderSeq::const_iterator iter = image.actors.begin();
    ...
    if (!this->add_subscription(sub->domainId, sub->participantId
      ...
      NDDS::DCPS::RepoIdConverter sub_converter(sub->actorId);
      NDDS::DCPS::RepoIdConverter part_converter(sub->participantId);
      ACE_ERROR((LM_ERROR,
                 ACE_TEXT("(%P|%t) ERROR: TAO_DDS_DCPSInfo_i::receive_image: ")
  ...
  for (Update::UImage::WriterSeq::const_iterator iter = image.wActors.begin();
    ...
    if (!this->add_publication(pub->domainId, pub->participantId
                               ...
                               , true)) {
      NDDS::DCPS::RepoIdConverter pub_converter(pub->actorId);
      NDDS::DCPS::RepoIdConverter part_converter(pub->participantId);
      ACE_ERROR((LM_ERROR,
                 ACE_TEXT("(%P|%t) ERROR: TAO_DDS_DCPSInfo_i::receive_image: ")
...
{
  std::string dump;
#if !defined (NDDS_INFOREPO_REDUCED_FOOTPRINT)
  std::string indent ("    ");
...
#endif // !defined (NDDS_INFOREPO_REDUCED_FOOTPRINT)
