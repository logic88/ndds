...
class NDDS_DCPSInfoRepoServ_Export InfoRepo
...
private:
  ...
  NDDS::Federator::ManagerImpl federator_;
  NDDS::Federator::Config      federatorConfig_;
...
class NDDS_DCPSInfoRepoServ_Export InfoRepo_Shutdown :
