#ifndef NDDS_DCPS_TIMEDURATION_H
#define NDDS_DCPS_TIMEDURATION_H
 ...
 * class.
 */
class NDDS_Dcps_Export TimeDuration : public SafeBool_T<TimeDuration> {
public:
...
NDDS_Dcps_Export TimeDuration operator+(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export TimeDuration operator-(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export TimeDuration operator-(const TimeDuration& x);
NDDS_Dcps_Export TimeDuration operator*(double x, const TimeDuration& y);
NDDS_Dcps_Export TimeDuration operator*(const TimeDuration& x, double y);
NDDS_Dcps_Export TimeDuration operator/(const TimeDuration& x, double y);
NDDS_Dcps_Export double operator/(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export bool operator<(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export bool operator>(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export bool operator<=(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export bool operator>=(const TimeDuration& x, const TimeDuration& y);
NDDS_Dcps_Export bool operator==(const TimeDuration& x, const TimeDuration& y);
