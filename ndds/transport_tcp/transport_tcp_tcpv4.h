...
#ifndef NDDS_DCPS_TRANSPORT_TCP_TCPTRANSPORT_H
#define NDDS_DCPS_TRANSPORT_TCP_TCPTRANSPORT_H
...
class NDDS_Tcp_Export TcpTransport
...
private:
  ...
  typedef NDDS_MAP(PriorityKey, TcpDataLink_rch)   LinkMap;
  typedef NDDS_MAP(PriorityKey, TcpConnection_rch) ConnectionMap;
