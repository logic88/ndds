...
#ifndef NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPRECEIVESTRATEGY_H
#define NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPRECEIVESTRATEGY_H
...
class NDDS_Rtps_Udp_Export RtpsUdpReceiveStrategy
...
public:
  ...
  typedef NDDS_VECTOR(SeqFragPair) FragmentInfo;
...
private:
  ...
  NDDS_VECTOR(RTPS::Submessage) secure_submessages_;
