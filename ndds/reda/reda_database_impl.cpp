...
NDDS::DCPS::PoolSynchStrategy::~PoolSynchStrategy()
{
  DBG_ENTRY_LVL("PoolSynchStrategy","~PoolSynchStrategy",6);
}

NDDS::DCPS::ThreadSynch*
NDDS::DCPS::PoolSynchStrategy::create_synch_object(
...
int
NDDS::DCPS::PoolSynchStrategy::open(void*)
{
...
int
NDDS::DCPS::PoolSynchStrategy::svc()
{
  // Future: ThreadStatus.
...
int
NDDS::DCPS::PoolSynchStrategy::close(u_long)
{
