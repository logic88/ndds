...
NDDS::DCPS::PerConnectionSynch::~PerConnectionSynch()
{
  DBG_ENTRY_LVL("PerConnectionSynch","~PerConnectionSynch",6);
}

void
NDDS::DCPS::PerConnectionSynch::work_available()
{
...
int
NDDS::DCPS::PerConnectionSynch::open(void*)
{
...
int
NDDS::DCPS::PerConnectionSynch::svc()
{
...
int
NDDS::DCPS::PerConnectionSynch::close(u_long)
{
...
int
NDDS::DCPS::PerConnectionSynch::register_worker_i()
{
...
void
NDDS::DCPS::PerConnectionSynch::unregister_worker_i()
{
