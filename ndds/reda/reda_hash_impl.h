...
#ifndef NDDS_DCPS_TRANSPORT_TCP_TCPINST_H
#define NDDS_DCPS_TRANSPORT_TCP_TCPINST_H
...
public:
  ...
  NDDS_STRING local_address_string() const { return local_address_str_; }
...
private:
  ...
  explicit TcpInst(const NDDS_STRING& name);
  virtual ~TcpInst();
