...
using ::NDDS::DCPS::MonotonicTimePoint;
using ::NDDS::DCPS::TimeDuration;
...
NDDS::DCPS::TcpConnection::TcpConnection()
  : is_connector_(false)
  , tcp_config_(0)
...
NDDS::DCPS::TcpConnection::TcpConnection(const ACE_INET_Addr& remote_address,
                                            Priority priority,
...
void
NDDS::DCPS::TcpConnection::set_datalink(const NDDS::DCPS::TcpDataLink_rch& link)
{
...
NDDS::DCPS::TcpSendStrategy_rch
NDDS::DCPS::TcpConnection::send_strategy()
{
  return this->link_->send_strategy();
}

NDDS::DCPS::TcpReceiveStrategy_rch
NDDS::DCPS::TcpConnection::receive_strategy()
{
  return this->link_->receive_strategy();
}

void
NDDS::DCPS::TcpConnection::disconnect()
{
...
int
NDDS::DCPS::TcpConnection::open(void* arg)
{
...
int
NDDS::DCPS::TcpConnection::active_open()
{
...
int
NDDS::DCPS::TcpConnection::passive_open(void* arg)
{
...
int
NDDS::DCPS::TcpConnection::handle_setup_input(ACE_HANDLE /*h*/)
{
...
int
NDDS::DCPS::TcpConnection::handle_input(ACE_HANDLE fd)
{
...
int
NDDS::DCPS::TcpConnection::handle_output(ACE_HANDLE)
{
...
int
NDDS::DCPS::TcpConnection::close(u_long)
{
...
const std::string&
NDDS::DCPS::TcpConnection::config_name() const
{
  return impl_->config().name();
}

int
NDDS::DCPS::TcpConnection::handle_close(ACE_HANDLE, ACE_Reactor_Mask)
{
  ThreadStatusManager::Event ev(TheServiceParticipant->get_thread_status_manager());
...
void
NDDS::DCPS::TcpConnection::set_sock_options(const TcpInst* tcp_config)
{
...
int
NDDS::DCPS::TcpConnection::on_active_connection_established()
{
...
void
NDDS::DCPS::TcpConnection::passive_reconnect_i()
{
...
void
NDDS::DCPS::TcpConnection::active_reconnect_i()
{
...
void
NDDS::DCPS::TcpConnection::notify_connection_lost()
{
  if (this->link_) {
...
void
NDDS::DCPS::TcpConnection::handle_stop_reconnecting()
{
...
int
NDDS::DCPS::TcpConnection::handle_timeout(const ACE_Time_Value &,
                                             const void *)
{
  ThreadStatusManager::Event ev(TheServiceParticipant->get_thread_status_manager());
...
/// connection object.
void
NDDS::DCPS::TcpConnection::transfer(TcpConnection* connection)
{
...
/// connection.
void
NDDS::DCPS::TcpConnection::notify_lost_on_backpressure_timeout()
{
...
/// action.
void
NDDS::DCPS::TcpConnection::relink_from_send(bool do_suspend)
{
...
void
NDDS::DCPS::TcpConnection::relink_from_recv(bool do_suspend)
{
...
bool
NDDS::DCPS::TcpConnection::tear_link()
{
...
void
NDDS::DCPS::TcpConnection::shutdown()
{
...
NDDS::DCPS::TcpConnection::add_reference()
{
  RcObject::_add_ref();
  return 1;
}
...
ACE_Event_Handler::Reference_Count
NDDS::DCPS::TcpConnection::remove_reference()
{
  RcObject::_remove_ref();
  return 1;
}

const char* NDDS::DCPS::TcpConnection::reconnect_state_string() const
{
...
int
NDDS::DCPS::TcpConnection::active_reconnect_open()
{
  ...
  if (result == -1) {
      ACE_ERROR_RETURN((LM_ERROR,
                        "(%P|%t) ERROR: NDDS::DCPS::TcpConnection::active_reconnect_open() can't register "
