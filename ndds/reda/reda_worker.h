...
#ifndef NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPSENDSTRATEGY_H
#define NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPSENDSTRATEGY_H
...
class NDDS_Rtps_Udp_Export RtpsUdpSendStrategy
...
private:
  ...
  bool encode_writer_submessage(const RepoId& receiver,
                                NDDS_VECTOR(Chunk)& replacements,
  ...
  ACE_Message_Block* replace_chunks(const ACE_Message_Block* plain,
                                    const NDDS_VECTOR(Chunk)& replacements);
#endif
