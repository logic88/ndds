...
#ifndef NDDS_DCPS_TRANSPORT_UDP_UDPRECEIVESTRATEGY_H
#define NDDS_DCPS_TRANSPORT_UDP_UDPRECEIVESTRATEGY_H
...
class NDDS_Udp_Export UdpReceiveStrategy
...
private:
  ...
  typedef NDDS_MAP(ACE_INET_Addr, ReassemblyInfo) ReassemblyMap;
