...
#ifndef NDDS_DCPS_TRANSPORT_TCP_TCPDATALINK_H
#define NDDS_DCPS_TRANSPORT_TCP_TCPDATALINK_H
...
#endif
  typedef NDDS_VECTOR(TransportQueueElement*) PendingRequestAcks;
  ACE_SYNCH_MUTEX pending_request_acks_lock_;
  PendingRequestAcks pending_request_acks_;
  typedef NDDS_SET_CMP(RepoId, GUID_tKeyLessThan) RepoIdSetType;
