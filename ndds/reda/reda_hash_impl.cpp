...
NDDS::DCPS::TcpInst::~TcpInst()
{
  DBG_ENTRY_LVL("TcpInst","~TcpInst",6);
}

NDDS::DCPS::TransportImpl_rch
NDDS::DCPS::TcpInst::new_impl()
{
  return make_rch<TcpTransport>(ref(*this));
}

int
NDDS::DCPS::TcpInst::load(ACE_Configuration_Heap& cf,
...
NDDS_STRING
NDDS::DCPS::TcpInst::dump_to_str() const
{
...
size_t
NDDS::DCPS::TcpInst::populate_locator(NDDS::DCPS::TransportLocator& local_info, ConnectionInfoFlags) const
{
