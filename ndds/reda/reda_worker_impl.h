...
#ifndef NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPTRANSPORT_H
#define NDDS_DCPS_TRANSPORT_RTPS_UDP_RTPSUDPTRANSPORT_H
...
class NDDS_Rtps_Udp_Export RtpsUdpTransport : public TransportImpl {
public:
...
private:
  ...
  virtual NDDS_STRING transport_type() const { return "rtps_udp"; }
