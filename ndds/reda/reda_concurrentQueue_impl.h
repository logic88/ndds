...
#ifndef NDDS_DCPS_TRANSPORT_FRAMEWORK_PACKETREMOVEVISITOR_H
#define NDDS_DCPS_TRANSPORT_FRAMEWORK_PACKETREMOVEVISITOR_H
...
class NDDS_Dcps_Export PacketRemoveVisitor
...
#endif  /* NDDS_DCPS_PACKETREMOVEVISTOR_H */
