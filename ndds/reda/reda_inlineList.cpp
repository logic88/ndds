...
NDDS::DCPS::TcpSendStrategy::TcpSendStrategy(
  std::size_t id,
  TcpDataLink& link,
...
void
NDDS::DCPS::TcpSendStrategy::schedule_output()
{
...
int
NDDS::DCPS::TcpSendStrategy::reset(bool reset_mode)
{
...
ssize_t
NDDS::DCPS::TcpSendStrategy::send_bytes(const iovec iov[], int n, int& bp)
{
...
ACE_HANDLE
NDDS::DCPS::TcpSendStrategy::get_handle()
{
...
ssize_t
NDDS::DCPS::TcpSendStrategy::send_bytes_i(const iovec iov[], int n)
{
  TcpConnection_rch connection = link_.get_connection();
...
void
NDDS::DCPS::TcpSendStrategy::relink(bool do_suspend)
{
...
void
NDDS::DCPS::TcpSendStrategy::stop_i()
{
  DBG_ENTRY_LVL("TcpSendStrategy","stop_i",6);
}

void
NDDS::DCPS::TcpSendStrategy::add_delayed_notification(TransportQueueElement* element)
{
...
void
NDDS::DCPS::TcpSendStrategy::terminate_send_if_suspended()
{
